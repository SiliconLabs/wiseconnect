...
/********************************************************************************
 * @file sl_wifi_net_profile_bgapi_cmd_lut_handler.c 
 *******************************************************************************
 * # License
...
const struct bgapi_cmd sli_bgapi_cmd_table_wifi_net_profile[] = {
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_delete,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_ap_ssid,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_ap_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_ap_channel,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_ap_ip_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_ap_ipv4_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_ap_ipv6_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_ap_ssid,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_ap_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_ap_channel,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_ap_ip_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_ap_ipv4_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_ap_ipv6_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_client_ssid,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_client_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_set_client_channel,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_client_ssid,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_client_config,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_net_profile_get_client_channel,
    .class_id = SLI_WIFI_NET_PROFILE_CLASS_ID,
