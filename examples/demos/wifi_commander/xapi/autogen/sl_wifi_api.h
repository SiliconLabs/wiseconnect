 ...
 */
typedef enum {
  APP_WIFI_NET_PROFILE_CREDENTIAL_ID_INVALID             = 0x0,   /**< (0x0)
                                                                       Invalid
                                                                       Credential
                                                                       ID. */
 ...
 */
typedef enum {
  APP_WIFI_NET_CRED_CREDENTIAL_ID_DEFAULT_WIFI_CLIENT_CREDENTIAL_ID = 0x1, /**<
                                                                                (0x1)
                                                                                Default
                                                                                Wi-Fi
                                                                                Client
                                                                                Credential
                                                                                ID. */
  APP_WIFI_NET_CRED_CREDENTIAL_ID_DEFAULT_WIFI_AP                   = 0x2  /**<
                                                                                (0x2)
                                                                                Default
                                                                                Wi-Fi
                                                                                Access
 ...
 */
typedef enum {
  APP_WIFI_NET_CRED_CREDENTIAL_TYPE_PSK = 0x1 /**< (0x1) Wi-Fi Pre-Shared Key
                                                    (PSK) Credential. */
...
PACKSTRUCT(struct app_wifi_evt_scan_results_event_s {
  ...
  sl_wifi_scan_ssid_t ssid; /**< Displays the SSID (Service Set
                                          Identifier) of the detected AP. */
  sl_wifi_bssid_t bssid;    /**< The BSSID (Basic Service Set
                                          Identifier) of the detected AP. */
});
...
PACKSTRUCT(struct app_wifi_evt_client_stats_response_event_s {
  ...
  uint8_t reason_code;   /**< Reason code. This field provides the reason
                                    code from the firmware's perspective: Reason
                                    code 0 means no specific reason was
                                    provided. */
  ...
  sl_wifi_bssid_t bssid; /**< BSSID of access point. If the value of
 ...
 */
static inline app_wifi_msg_t *sl_wifi_get_command_response()
{
  return (app_wifi_msg_t *)sl_bgapi_get_command_response();
}
