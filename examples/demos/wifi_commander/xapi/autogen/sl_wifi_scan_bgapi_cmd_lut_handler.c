...
/********************************************************************************
 * @file sl_wifi_scan_bgapi_cmd_lut_handler.c 
 *******************************************************************************
 * # License
...
const struct bgapi_cmd sli_bgapi_cmd_table_wifi_scan[] = {
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_scan_start,
    .class_id = SLI_WIFI_SCAN_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_scan_start_with_ssid,
    .class_id = SLI_WIFI_SCAN_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_scan_set_advanced_configuration,
    .class_id = SLI_WIFI_SCAN_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_scan_get_advanced_configuration,
    .class_id = SLI_WIFI_SCAN_CLASS_ID,
  ...
  {
    .handler = (sl_bgapi_handler)app_wifi_cmd_scan_stop,
    .class_id = SLI_WIFI_SCAN_CLASS_ID,
