...
#include "app_simple_com_freertos_config.h"

/// Task stack definition and identifier
//static StackType_t  simple_com_task_stack[APP_SIMPLE_COM_TASK_STACK] = { 0 };
...
void app_simple_com_os_task_init(void)
{
  ...
  xTaskCreate(simple_com_task,
              APP_SIMPLE_COM_TASK_NAME,
              APP_SIMPLE_COM_TASK_STACK,
              NULL,
              APP_SIMPLE_COM_TASK_PRIO,
