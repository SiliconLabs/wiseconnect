...
#define RSI_TCP_IP_FEATURE_BIT_MAP    \
  (SL_SI91X_TCP_IP_FEAT_DHCPV4_CLIENT \
   | SL_SI91X_TCP_IP_FEAT_SSL) //! TCP/IP feature select bitmap for selecting TCP/IP features
...
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (SL_SI91X_EXT_FEAT_LOW_POWER_MODE | BIT(22))
#endif
