 ...
 * To wrap the input key and use it, set WRAP_INPUT_KEYS macro to 1 in [`psa_ccm_app.c`](psa_ccm_app.c)
 * To use a wrapped key directly, set IMPORT_WRAPPED_KEYS macro to 1 in [`psa_ccm_app.c`](psa_ccm_app.c)
