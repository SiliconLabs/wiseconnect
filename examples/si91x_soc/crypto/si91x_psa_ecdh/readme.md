...
- [PSA ECDH for SI91X](#psa-ecdh-for-si91x)
...
-  To change the ecc curve and key size, set secpr1_key_size_select variable to the correct key_size in [`app.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.2-content-for-docs/examples/si91x_soc/crypto/si91x_psa_ecdh/app.c)
