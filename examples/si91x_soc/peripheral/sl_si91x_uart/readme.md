...
- [`uart_example.c`](uart_example.c) - This example code demonstrates how to configure the UART to send and receive data.
...
- Configure the following macros in [`uart_example.c`](uart_example.c) if required:
