...
- Configure the following parameter in [`app.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.0-content-for-docs/examples/si91x_soc/peripheral/psram_blinky/app.c) file, update/modify following macro if required
