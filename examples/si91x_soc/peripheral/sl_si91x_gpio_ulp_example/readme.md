...
- [SL GPIO ULP EXAMPLE](#sl-gpio-ulp-example)
...
- Use \ref [sl_gpio_set_configuration](https://docs.silabs.com/wiseconnect/3.5.0/wiseconnect-api-reference-guide-si91x-peripherals/gpio#sl-gpio-set-configuration)(). This configures the GPIO pin based on the port and pin, direction.
- Use \ref [sl_gpio_configure_pin_interrupt](https://docs.silabs.com/wiseconnect/3.5.0/wiseconnect-api-reference-guide-si91x-peripherals/gpio#sl-gpio-driver-configure-interrupt)(). This configures the pin interrupt for GPIO.
