...
- Use [sl_si91x_gpio_driver_configure_group_interrupt](https://docs.silabs.com/wiseconnect/latest/wiseconnect-api-reference-guide-si91x-peripherals/gpio#sl-si91x-gpio-driver-configure-group-interrupt)(). This configures the group interrupt for HP GPIO instance.
- Use [sl_si91x_gpio_driver_configure_ulp_group_interrupt](https://docs.silabs.com/wiseconnect/latest/wiseconnect-api-reference-guide-si91x-peripherals/gpio#sl-si91x-gpio-driver-configure-ulp-group-interrupt)(). This configures the group interrupt for ULP GPIO instance.
