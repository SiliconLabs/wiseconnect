...
5. Select OPAMP reference voltage **2.5V or 3.3V** and OPAMP configuration **Unity Gain** ,**Inverting PGA**, **Non-Inverting PGA**, **Inverting with Hysteresis**,   **Non-Inverting with Hysteresis**  **Cascaded Inverting PGA**, **Cascaded Non-Inverting PGA** or **Two OPAMPs Diff Amp** from UC.
...
The following table lists the pin numbers for the radio board. If you want to use a radio board other than BRD4338A, BRD4343A, or BRD4342A, refer to the board user guide.
