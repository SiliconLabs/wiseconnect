...
- Using the configuration wizard, you can configure different parameters like:
  ...
  - **General Configuration**
    ...
    - Configure the following macros in [`i2s_loopback_example.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.3-content-for-docs/examples/si91x_soc/peripheral/sl_si91x_i2s_loopback/i2s_loopback_example.c) file and update/modify following macros if required.
