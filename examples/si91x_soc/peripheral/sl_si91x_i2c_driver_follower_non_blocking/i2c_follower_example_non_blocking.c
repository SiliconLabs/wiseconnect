/***************************************************************************/ /**
* @file i2c_follower_example_non_blocking.c
* @brief I2C Follower Non Blocking example functions
*******************************************************************************
* # License
...
*
******************************************************************************/
#include "i2c_follower_example_non_blocking.h"
#include "rsi_debug.h"
...
void i2c_follower_example_init(void)
{
  ...
  sl_i2c_config.i2c_callback = i2c_follower_callback;
  ...
  switch (current_mode) {
    case I2C_RECEIVE_DATA:
      ...
      if (i2c_driver_dma_error) {
        DEBUGOUT("Data is not received from Leader \n");
    ...
    case I2C_SEND_DATA:
      ...
      if (i2c_transfer_complete) {
        ...
        DEBUGOUT("Data is not sent to Leader \n");
        i2c_driver_dma_error = false;
        current_mode         = I2C_TRANSMISSION_COMPLETED;
        break;
      }
