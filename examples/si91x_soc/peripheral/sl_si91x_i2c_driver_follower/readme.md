...
- After the above UC configurations, also configure following macros in [`i2c_follower_example.c`](i2c_follower_example.c) file and update/modify following macros, if required.
