...
- Current_mode enum is set to I2C_RECEIVE_DATA, it receives data from leader through \ref sl_i2c_driver_receive_data_blocking for blocking Application.
...
- Then it calls send_data API to send data to leader through \ref sl_i2c_driver_send_data_blocking for blocking Application.
...
- Windows PC
- Silicon Labs Si917 Evaluation Kit [WPK(BRD4002) +  BRD4338A / BRD4342A / BRD4343A / BRD4344A ] - as a Follower
- Silicon Labs Si917 Evaluation Kit [WPK(BRD4002) +  BRD4338A / BRD4342A / BRD4343A / BRD4344A ] - as a Leader
- SiWx917 AC1 Module Explorer Kit [BRD2708A / BRD2911A] - as a Follower
- SiWx917 AC1 Module Explorer Kit [BRD2708A / BRD2911A] - as a Leader
...
2. Connect SCL(ULP_GPIO_7) and SDA(ULP_GPIO_6) pins with the leader device.If SiWG915 board connect SCL(GPIO_7) and SDA(GPIO_6) pins with the leader device.
