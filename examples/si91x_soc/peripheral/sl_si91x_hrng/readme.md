...
- Include the HRNG header file in your project:
  ...
  #include ["sl_si91x_hrng.h"](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.3-content-for-docs/components/device/silabs/si91x/mcu/drivers/unified_api/inc/sl_si91x_hrng.h)
