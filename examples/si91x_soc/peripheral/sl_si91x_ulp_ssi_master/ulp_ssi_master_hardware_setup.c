/*******************************************************************************
* @file  sl_ulp_ssi_master_hardware_setup.c
* @brief
*******************************************************************************
* # License
...
void hardware_setup(void)
{
  ...
  */
  ...
  RSI_PS_UlpssPeriPowerDown(ULPSS_PWRGATE_ULP_AUX | ULPSS_PWRGATE_ULP_CAP | ULPSS_PWRGATE_ULP_I2S
                            | ULPSS_PWRGATE_ULP_I2C | ULPSS_PWRGATE_ULP_IR | ULPSS_PWRGATE_ULP_FIM);
