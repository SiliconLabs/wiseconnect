...
- This application demonstrates how to configure USART In syncronous mode as a slave, it will send and receive data in loopback mode
...
- The Application has been conifgured to run in Synchronous Slave mode.
