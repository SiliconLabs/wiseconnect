...
- Connect Master and slave as per pin configurations i.e Connect USART master clock pin(GPIO_8/GPIO_25) to USART slave clock pin, Master TX pin(GPIO_30) to Slave RX pin, Master RX pin(GPIO_29) to Slave TX pin.

 - Connect Salve and Master as per pin configurations i.e Connect USART slave clock pin (GPIO_8/GPIO_25)to USART master clock pin(GPIO_8), Slave RX(GPIO_29) pin to Master TX pin(GPIO_30), Slave TX pin(GPIO_30) to Master RX pin(GPIO_29).
