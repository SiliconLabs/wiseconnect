...
2. Connect SCL(ULP_GPIO_7) and SDA(ULP_GPIO_6) pins with the follower device.If SiWG915 board connect SCL(GPIO_7) and SDA(GPIO_6) pins with the leader device.
