...
#ifndef SL_SI91X_SSI_MASTER_FREERTOS_H_
#define SL_SI91X_SSI_MASTER_FREERTOS_H_

#define SSI_MASTER_TRANSFER ENABLE
#define SSI_MASTER_SEND     DISABLE
#define SSI_MASTER_RECEIVE  DISABLE
...
#endif /* SL_SI91X_SSI_MASTER_FREERTOS_H_ */
