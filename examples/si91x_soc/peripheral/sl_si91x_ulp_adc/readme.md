...
- Once sampling is done callback will hit and set the true "data_sample_complete_flag" flag to read the sampled data using \ref sl_si91x_adc_read_data API for FIFO mode of ADC or \ref sl_si91x_adc_read_data_static API for static mode of ADC. This process will run continuously.
