...
- SiWx91x DMA supports 3 types of DMA transfers. They are memory to memory, peripheral to memory, memory to peripheral
...
- [`ulp_dma_example.c`](ulp_dma_example.c) file demonstrates how to use DMA peripheral to perform memory to memory transfers
...
- Configure the following macros in [`ulp_dma_example.c`](ulp_dma_example.c) file and update/modify following macros if required.
