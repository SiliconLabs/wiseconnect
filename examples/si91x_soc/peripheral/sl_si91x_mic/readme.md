...
- Configure the following parameters in [`mic_example.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.3-content-for-docs/examples/si91x_soc/peripheral/sl_si91x_mic/mic_example.c) file, update/modify following macro if required.
