...
#ifndef USART_EXAMPLE_H_
#define USART_EXAMPLE_H_
...
#define SL_USART_SYNCH_MODE DISABLE ///< To validate the synchronous mode, this macro needs to be enabled
