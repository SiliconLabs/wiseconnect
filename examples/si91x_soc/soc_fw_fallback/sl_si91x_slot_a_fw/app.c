...
void sl_app_display_ab_slot_info(const sl_si91x_fw_ab_slot_management_t *slot_info)
{
  ...
  DEBUGOUT("\r\nMagic Word: 0x%" PRIx32, (uint32_t)slot_info->slot_magic_word);

  // M4 Slot Information
  DEBUGOUT("\r\n---- M4 Slot Information ----");
  DEBUGOUT("\r\nM4 Slot A:");
  DEBUGOUT("\r\n  Slot ID: %u", (unsigned int)slot_info->m4_slot_info.m4_slot_A.slot_id);
  DEBUGOUT("\r\n  Image Offset: 0x%" PRIx32,
           (uint32_t)(slot_info->m4_slot_info.m4_slot_A.slot_image_offset & 0x00FFFFFFU));
  DEBUGOUT("\r\n  Image Size: 0x%" PRIx32 " bytes", (uint32_t)slot_info->m4_slot_info.m4_slot_A.image_size);

  DEBUGOUT("\r\nM4 Slot B:");
  DEBUGOUT("\r\n  Slot ID: %u", (unsigned int)slot_info->m4_slot_info.m4_slot_B.slot_id);
  DEBUGOUT("\r\n  Image Offset: 0x%" PRIx32,
           (uint32_t)(slot_info->m4_slot_info.m4_slot_B.slot_image_offset & 0x00FFFFFFU));
  DEBUGOUT("\r\n  Image Size: 0x%" PRIx32 " bytes", (uint32_t)slot_info->m4_slot_info.m4_slot_B.image_size);
  ...
  DEBUGOUT("\r\n---- NWP Slot Information ----");
  DEBUGOUT("\r\nNWP Slot A:");
  DEBUGOUT("\r\n  Slot ID: %u", (unsigned int)slot_info->nwp_slot_info.nwp_slot_A.slot_id);
  DEBUGOUT("\r\n  Image Offset: 0x%" PRIx32,
           (uint32_t)(slot_info->nwp_slot_info.nwp_slot_A.slot_image_offset & 0x00FFFFFFU));
  DEBUGOUT("\r\n  Image Size: 0x%" PRIx32 " bytes", (uint32_t)slot_info->nwp_slot_info.nwp_slot_A.image_size);

  DEBUGOUT("\r\nNWP Slot B:");
  DEBUGOUT("\r\n  Slot ID: %u", (unsigned int)slot_info->nwp_slot_info.nwp_slot_B.slot_id);
  DEBUGOUT("\r\n  Image Offset: 0x%" PRIx32,
           (uint32_t)(slot_info->nwp_slot_info.nwp_slot_B.slot_image_offset & 0x00FFFFFFU));
  DEBUGOUT("\r\n  Image Size: 0x%" PRIx32 " bytes", (uint32_t)slot_info->nwp_slot_info.nwp_slot_B.image_size);
  ...
  DEBUGOUT("\r\nSlot Structure CRC: 0x%" PRIx32, (uint32_t)slot_info->slot_struct_crc);
  DEBUGOUT("\r\n=============================================\r\n");
}
