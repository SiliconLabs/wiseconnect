...
This example downloads M4 firmware over Wi-Fi from a TCP server and programs the device flash (Slot A). It is used with the A/B fallback flow for OTA updates.
