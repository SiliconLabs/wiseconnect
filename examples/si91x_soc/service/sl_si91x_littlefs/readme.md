...
- The example code in [`file_system_example.c`](https://github.com/SiliconLabs/wiseconnect/blob/v4.0.3-content-for-docs/examples/si91x_soc/service/sl_si91x_littlefs/file_system_example.c) shows how to set up QSPI to access flash memory for a file system using the LittleFS library.
