 ...
 * @param[in] resp_enh_conn, connected remote device information
 * @return     none.
 * @section description
 ...
 * @param[in]  uuid_32bit, 32 bit uuid.
 * @param[out] serv_uuid, 128 bit uuid.
 * @return     none.
 *             0  =  success
 *             !0 = failure
 * @section description
 ...
 * @param[out] adv_report, pointer to the received advertising report
 * @return     none.
 * @section description
  ...
  while (1) {
    ...
    switch (event_id) {
      ...
      case RSI_BLE_GATT_WRITE_EVENT: {
        ...
        SL_DEBUG_LOG_V2(INFO, "Received packet type = %d\r\n", app_ble_write_event.pkt_type);
      ...
      case RSI_BLE_DISABLE_REQUEST: {
        ...
        /* Quiesce before BLE disable: disconnect; app_ble_disable runs after RSI_BLE_DISCONN_EVENT. */
