...
> **NOTE :**
> Amazon uses [Starfield Technologies](https://www.starfieldtech.com/) certificates to secure the AWS website. The WiSeConnect SDK includes the [Starfield CA Certificate](https://github.com/SiliconLabs/wiseconnect/tree/v4.0.3-content-for-docs/resources/certificates/aws_starfield_ca.pem.h).
>
