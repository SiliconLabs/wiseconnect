...
#define RSI_BLE_MAX_DATA_LEN_C1 232
#else
...
#define CONN_INTERVAL_C1            200 //! for conn interval of 250ms, conn_interval = N*1.25ms
#define CONN_LATENCY_C1             0
#define CONN_SUPERVISION_TIMEOUT_C1 1000
...
#define CONN_INTERVAL_C2            200 //! for conn interval of 250ms
#define CONN_LATENCY_C2             0
#define CONN_SUPERVISION_TIMEOUT_C2 1600
...
#endif
//! Configure below macros to select connection paramaters while data transfer
#define CONN_INTERVAL_P1            200 //! for conn interval of 250ms
#define CONN_LATENCY_P1             0
#define CONN_SUPERVISION_TIMEOUT_P1 1600
...
#endif
//! Configure below macros to select connection parameters while data transfer
#define CONN_INTERVAL_P2            200 //! for conn interval of 250ms
#define CONN_LATENCY_P2             0
#define CONN_SUPERVISION_TIMEOUT_P2 1600
...
#endif
//! Configure below macros to select connection paramaters while data transfer
#define CONN_INTERVAL_P3            200 //! for conn interval of 250ms
#define CONN_LATENCY_P3             0
#define CONN_SUPERVISION_TIMEOUT_P3 1600
...
/***********************************************************************************************************************************************/
//! Characteristic Presentation Format Fields
/***********************************************************************************************************************************************/
...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP \
  (SL_SI91X_EXT_FEAT_XTAL_CLK | RAM_LEVEL_NWP_ADV_MCU_BASIC | SL_SI91X_EXT_FEAT_FRONT_END_SWITCH_PINS_ULP_GPIO_4_5_0)
#else
