...
To esstablish the TCP Server with firmware file on remote PC, follow the steps below:
 ...
 1. Copy the TCP server application [firmware_update_tcp_server_9117.c](https://github.com/SiliconLabs/wiseconnect/tree/v4.1.0-content-for-docs/examples/snippets/wlan/m4_firmware_update/firmware_update_tcp_server_9117.c) provided with the application source to a Linux PC connected to the Wi-Fi access point.
