...
- Navigate to the Wireless Security section and enable the **WPA/WPA2 - Enterprise** option, as shown in the following figure. Following image is for a TP-Link Access Point.
