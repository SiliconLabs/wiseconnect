...
3. Payload data and signature data should to copied in two separate files using hex editor. Before copying, remove the trailing 0's from the signature and run the below command for signature verification
