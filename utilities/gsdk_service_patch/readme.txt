...
1. After copying wiseconnect3 release package in gsdk/extension/, Run git apply "extension/wiseconnect3/utilities/gsdk_service_patch/gsdk_service.patch" command from gsdk.
2. Ignore any warnings regarding whitespace errors