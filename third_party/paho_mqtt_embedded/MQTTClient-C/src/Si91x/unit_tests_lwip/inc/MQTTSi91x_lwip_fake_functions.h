...
DECLARE_FAKE_VALUE_FUNC5(int, setsockopt, int, int, int, const void *, socklen_t);
DECLARE_FAKE_VALUE_FUNC4(ssize_t, recv, int, void *, size_t, int);
DECLARE_FAKE_VALUE_FUNC4(int, send, int, const void *, size_t, int);
DECLARE_FAKE_VALUE_FUNC3(int, socket, int, int, int);
DECLARE_FAKE_VALUE_FUNC3(int, bind, int, const struct sockaddr *, socklen_t);
DECLARE_FAKE_VALUE_FUNC3(int, connect, int, const struct sockaddr *, socklen_t);

// Fakes for TLS and time functions
DECLARE_FAKE_VALUE_FUNC0(uint32_t, sys_now);

DECLARE_FAKE_VALUE_FUNC5(int, lwip_select, int, fd_set *, fd_set *, fd_set *, struct timeval *);
DECLARE_FAKE_VALUE_FUNC3(ssize_t, lwip_read, int, void *, size_t);
DECLARE_FAKE_VALUE_FUNC3(ssize_t, lwip_write, int, const void *, size_t);
DECLARE_FAKE_VALUE_FUNC1(int, lwip_close, int);
DECLARE_FAKE_VALUE_FUNC3(int, lwip_socket, int, int, int);
DECLARE_FAKE_VALUE_FUNC3(int, lwip_bind, int, const struct sockaddr *, socklen_t);
DECLARE_FAKE_VALUE_FUNC3(int, lwip_connect, int, const struct sockaddr *, socklen_t);
DECLARE_FAKE_VALUE_FUNC1(uint16_t, lwip_htons, uint16_t);
DECLARE_FAKE_VALUE_FUNC4(ssize_t, lwip_recv, int, void *, size_t, int);
DECLARE_FAKE_VALUE_FUNC4(ssize_t, lwip_send, int, const void *, size_t, int);
...
DECLARE_FAKE_VALUE_FUNC2(int, mbedtls_ssl_setup, mbedtls_ssl_context *, const mbedtls_ssl_config *);
DECLARE_FAKE_VALUE_FUNC2(int, mbedtls_ssl_set_hostname, mbedtls_ssl_context *, const char *);
DECLARE_FAKE_VOID_FUNC5(mbedtls_ssl_set_bio,
                        mbedtls_ssl_context *,
                        void *,
                        mbedtls_ssl_send_t *,
                        mbedtls_ssl_recv_t *,
                        mbedtls_ssl_recv_timeout_t *);
DECLARE_FAKE_VALUE_FUNC1(int, mbedtls_ssl_handshake, mbedtls_ssl_context *);
DECLARE_FAKE_VOID_FUNC2(mbedtls_ssl_conf_read_timeout, mbedtls_ssl_config *, uint32_t);
