...
int check_subs_exist(MQTTClient *c, const char *test_topic, int which)
{
  ...
  rc = (((which == 1 || which == 3) && test1_message_data) || (which == 2 && test1_message_data == NULL)) ? SUCCESS
                                                                                                          : FAILURE;
  assert("test1 subscription", rc == SUCCESS, "test1_message_data %p\n", test1_message_data);
  rc = (((which == 2 || which == 3) && test2_message_data) || (which == 1 && test2_message_data == NULL)) ? SUCCESS
                                                                                                          : FAILURE;
