...
void QCBORDecode_GetEpochDateInMapN(QCBORDecodeContext *pCtx, int64_t nLabel, uint8_t uTagRequirement, int64_t *pnTime);
...
void QCBORDecode_GetEpochDaysInMapN(QCBORDecodeContext *pCtx, int64_t nLabel, uint8_t uTagRequirement, int64_t *pnDays);
...
/**
 ...
 @ref QCBOR_TYPE_UUID.
 */
static inline void QCBORDecode_GetBinaryUUID(QCBORDecodeContext *pCtx, uint8_t uTagRequirement, UsefulBufC *pUUID);
...
inline static void QCBORDecode_GetDoubleConvert(QCBORDecodeContext *pMe, uint32_t uConvertTypes, double *pdValue)
{
  QCBORItem Item;
...
static inline void QCBORDecode_GetByteString(QCBORDecodeContext *pMe, UsefulBufC *pValue)
{
  // Complier should make this just a 64-bit integer parameter
  const TagSpecification TagSpec = { QCBOR_TAG_REQUIREMENT_NOT_A_TAG,
...
inline static void QCBORDecode_GetByteStringInMapN(QCBORDecodeContext *pMe, int64_t nLabel, UsefulBufC *pBstr)
{
  const TagSpecification TagSpec = { QCBOR_TAG_REQUIREMENT_NOT_A_TAG,
                                     { QCBOR_TYPE_BYTE_STRING, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE },
                                     { QCBOR_TYPE_BYTE_STRING, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE } };
...
inline static void QCBORDecode_GetByteStringInMapSZ(QCBORDecodeContext *pMe, const char *szLabel, UsefulBufC *pBstr)
{
  const TagSpecification TagSpec = { QCBOR_TAG_REQUIREMENT_NOT_A_TAG,
                                     { QCBOR_TYPE_BYTE_STRING, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE },
                                     { QCBOR_TYPE_BYTE_STRING, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE } };
...
static inline void QCBORDecode_GetTextString(QCBORDecodeContext *pMe, UsefulBufC *pValue)
{
...
inline static void QCBORDecode_GetTextStringInMapN(QCBORDecodeContext *pMe, int64_t nLabel, UsefulBufC *pText)
{
...
inline static void QCBORDecode_GetTextStringInMapSZ(QCBORDecodeContext *pMe, const char *szLabel, UsefulBufC *pText)
{
  const TagSpecification TagSpec = { QCBOR_TAG_REQUIREMENT_NOT_A_TAG,
                                     { QCBOR_TYPE_TEXT_STRING, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE },
                                     { QCBOR_TYPE_TEXT_STRING, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE, QCBOR_TYPE_NONE } };
...
static inline void QCBORDecode_GetNull(QCBORDecodeContext *pMe)
{
  QCBORItem item;
...
static inline void QCBORDecode_GetNullInMapN(QCBORDecodeContext *pMe, int64_t nLabel)
{
  QCBORItem Item;
  QCBORDecode_GetItemInMapN(pMe, nLabel, QCBOR_TYPE_NULL, &Item);
}

static inline void QCBORDecode_GetNullInMapSZ(QCBORDecodeContext *pMe, const char *szLabel)
{
  QCBORItem Item;
  QCBORDecode_GetItemInMapSZ(pMe, szLabel, QCBOR_TYPE_NULL, &Item);
}

static inline void QCBORDecode_GetUndefined(QCBORDecodeContext *pMe)
{
  QCBORItem item;
...
static inline void QCBORDecode_GetUndefinedInMapN(QCBORDecodeContext *pMe, int64_t nLabel)
{
  QCBORItem Item;
  QCBORDecode_GetItemInMapN(pMe, nLabel, QCBOR_TYPE_UNDEF, &Item);
}

static inline void QCBORDecode_GetUndefinedInMapSZ(QCBORDecodeContext *pMe, const char *szLabel)
{
  QCBORItem Item;
...
static inline void QCBORDecode_GetDaysString(QCBORDecodeContext *pMe, uint8_t uTagRequirement, UsefulBufC *pValue)
{
  const TagSpecification TagSpec = { uTagRequirement,
...
inline static void QCBORDecode_GetDaysStringInMapN(QCBORDecodeContext *pMe,
                                                   int64_t nLabel,
                                                   uint8_t uTagRequirement,
                                                   UsefulBufC *pText)
{
...
inline static void QCBORDecode_GetDaysStringInMapSZ(QCBORDecodeContext *pMe,
                                                    const char *szLabel,
                                                    uint8_t uTagRequirement,
                                                    UsefulBufC *pText)
{
...
static inline void QCBORDecode_GetURI(QCBORDecodeContext *pMe, uint8_t uTagRequirement, UsefulBufC *pUUID)
{
  const TagSpecification TagSpec = { uTagRequirement,
...
static inline void QCBORDecode_GetB64(QCBORDecodeContext *pMe, uint8_t uTagRequirement, UsefulBufC *pB64Text)
{
  const TagSpecification TagSpec = { uTagRequirement,
...
static inline void QCBORDecode_GetB64URL(QCBORDecodeContext *pMe, uint8_t uTagRequirement, UsefulBufC *pB64Text)
{
  const TagSpecification TagSpec = { uTagRequirement,
...
static inline void QCBORDecode_GetRegex(QCBORDecodeContext *pMe, uint8_t uTagRequirement, UsefulBufC *pRegex)
{
  const TagSpecification TagSpec = { uTagRequirement,
                                              ...
                                              bool *pbIsTag257)
{
  ...
  pMe->uLastError = (uint8_t)QCBORDecode_GetMIMEInternal(uTagRequirement, &Item, pMessage, pbIsTag257);
}
