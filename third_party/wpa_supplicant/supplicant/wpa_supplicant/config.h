...
#define DEFAULT_BSS_MAX_COUNT 11//200
#define DEFAULT_BSS_EXPIRATION_AGE 180
#define DEFAULT_BSS_EXPIRATION_SCAN_COUNT 2
#define DEFAULT_MAX_NUM_STA 16//128
...
struct wpa_config {
	...
	/*Roaming featre params: Needed by supplicant to decide the roaming*/	
		int roam_hysteresis;
	  int roam_threshold;
