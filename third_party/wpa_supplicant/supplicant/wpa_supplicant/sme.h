...
static inline int sme_update_ft_ies(struct wpa_supplicant *wpa_s, const unsigned char *md,
...
sme_disassoc_while_authenticating(struct wpa_supplicant *wpa_s,
				  const unsigned char *prev_pending_bssid)
{
}
...
static inline void sme_external_auth_mgmt_rx(struct wpa_supplicant *wpa_s,
					     const unsigned char *auth_frame, size_t len)
{
}
