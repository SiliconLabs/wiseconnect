...
void wpas_mbo_non_pref_chan_changed(struct wpa_supplicant *wpa_s)
{
	struct wpabuf *buf;
...
int wpa_non_pref_chan_is_eq(struct wpa_mbo_non_pref_channel *a,
 ...
 */
int wpa_non_pref_chan_cmp(const void *_a, const void *_b)
{
