 ...
 */
DECLARE_ACCESSOR(wpas_dbus_setter_p2p_device_properties);
DECLARE_ACCESSOR(wpas_dbus_getter_p2p_device_properties);
...
#endif
DECLARE_ACCESSOR(wpas_dbus_getter_p2p_peer_properties);
...
#endif
DECLARE_ACCESSOR(wpas_dbus_getter_p2p_group_properties);
/*
