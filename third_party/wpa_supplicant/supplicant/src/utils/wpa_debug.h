...
#ifndef DBG_PRINTF_OBE
#define  wpa_printf(level,args...)   tfp_printf(args)
#define  wpa_msg(x,level,args...)    tfp_printf(args)
#define  wpa_dbg(x,level,args...)    tfp_printf(args)
#else 
#define wpa_printf(args...) dbg_printf_obe_insert_eol(__FUNCTION__)
#endif
#else 
#define  wpa_printf(level,args...)   do { } while(0)
#define  wpa_msg(x,level,args...)    do { } while(0)
#define  wpa_dbg(x,level,args...)    do { } while(0)
#endif
...
#if ENABLE_SUPPLICANT_PRINTS
void init_printf(void* putp,void (*putf) (void*,char));
//void init_printf(void* putp,void (*putf) (char));

void tfp_printf(char *fmt, ...);
void tfp_sprintf(char* s,int size ,char *fmt, ...);

void tfp_format(void* putp,void (*putf) (void*,char),char *fmt, va_list va);
//void tfp_format(void* putp,void (*putf) (char),char *fmt, va_list va);
