				  ...
				  size_t len)
{
	 ...
	 * extra copy here */
#ifndef ENABLE_PREAUTHENTICATION
...
#else
         wpa_sm_ether_send(sm, sm->preauth_bssid, ETH_P_RSN_PREAUTH, msg, msglen);
#endif	
	os_free(msg);
	return res;
}
 ...
 */
//void rsn_preauth_candidate_process(struct wpa_sm *sm)_OBE_LOW_POWER_RAM_
void rsn_preauth_candidate_process(struct wpa_sm *sm)
{
	...
	SLI_WLAN_MGMT_ASSERT(WSC_ASSERT_PREAUTH_DISABLED_2);
#endif
}
