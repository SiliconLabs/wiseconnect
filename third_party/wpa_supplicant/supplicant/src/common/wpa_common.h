...
#define CHANNEL_GOOD	0   /*ROAMING Change*/
#define CHANNEL_NOISY	1   /*ROAMING Change*/
...
void
wpa_cckm_hmac_calculatev1(u8 *key, u8 key_len, u8 *wpa_ie, u8 wpa_ie_len, u8 *addr1, u8 *addr2, int rekey_number,
...
void wpa_btk_to_ptk(const u8 *pmk, size_t pmk_len, int *rn, u8 *label,
		u8 *ptk, size_t ptk_len);
#endif
