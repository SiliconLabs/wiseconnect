...
STATIC void eapol_port_timers_tick(void *eloop_ctx, void *timeout_ctx)__attribute__((section(".obe_low_power_ram")));
STATIC void eapol_port_timers_tick(void *eloop_ctx, void *timeout_ctx)
{
...
#else
void sm_SUPP_PAE_CONNECTING_Enter(STATE_MACHINE_DATA *sm, int global)  
#endif
{
...
#else
void sm_KEY_RX_NO_KEY_RECEIVE_Enter(STATE_MACHINE_DATA *sm, int global)
#endif
{
...
#else
void sm_KEY_RX_KEY_RECEIVE_Enter(STATE_MACHINE_DATA *sm, int global)
#endif
{
...
#else
void sm_SUPP_BE_REQUEST_Enter(STATE_MACHINE_DATA *sm, int global)  
#endif
{
...
#else
void sm_SUPP_BE_RESPONSE_Enter(STATE_MACHINE_DATA *sm, int global)  
#endif
{
...
#else
void sm_SUPP_BE_RECEIVE_Enter(STATE_MACHINE_DATA *sm, int global)  
#endif
{
...
void eapol_sm_step_timeout(void *eloop_ctx, void *timeout_ctx);
void eapol_sm_set_port_authorized(struct eapol_sm *sm);
void eapol_sm_set_port_unauthorized(struct eapol_sm *sm);
