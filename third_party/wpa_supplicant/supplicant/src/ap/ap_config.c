...
#else
 ssid->wpa_psk->psk[0] = 0x40;
  ssid->wpa_psk->psk[1] = 0xda;
  ssid->wpa_psk->psk[2] = 0xd5;
  ssid->wpa_psk->psk[3] = 0x9c;
  ssid->wpa_psk->psk[4] = 0x81; 
  ssid->wpa_psk->psk[5] = 0x3d;
  ssid->wpa_psk->psk[6] = 0x3d;
  ssid->wpa_psk->psk[7] = 0x35;
  ssid->wpa_psk->psk[8] = 0x72;
  ssid->wpa_psk->psk[9] = 0x1d;
  ssid->wpa_psk->psk[10] = 0x7c;
  ssid->wpa_psk->psk[11] = 0xee;
  ssid->wpa_psk->psk[12] = 0xb3;
  ssid->wpa_psk->psk[13] = 0x11;
  ssid->wpa_psk->psk[14] = 0x3a;
  ssid->wpa_psk->psk[15] = 0x40;
  ssid->wpa_psk->psk[16] = 0xa1;
  ssid->wpa_psk->psk[17] = 0x9d;
  ssid->wpa_psk->psk[18] = 0xe7;
  ssid->wpa_psk->psk[19] = 0xad;
  ssid->wpa_psk->psk[20] = 0x58;
  ssid->wpa_psk->psk[21] = 0x42;
  ssid->wpa_psk->psk[22] = 0xd8;
  ssid->wpa_psk->psk[23] = 0x3c;
  ssid->wpa_psk->psk[24] = 0xa2;
  ssid->wpa_psk->psk[25] = 0x95;
  ssid->wpa_psk->psk[26] = 0x1d;
  ssid->wpa_psk->psk[27] = 0xfe;
  ssid->wpa_psk->psk[28] = 0xC5;
  ssid->wpa_psk->psk[29] = 0x75;
  ssid->wpa_psk->psk[30] = 0xac;
  ssid->wpa_psk->psk[31] = 0xfc;
#endif
...
{
#ifdef RADIU_SERVER /* This accept_attr parameter will come in picture of RADIUS_SERVER */	
...
#endif
#ifdef ENABLE_80211V /* K60_PORTING */
...
#endif /* CONFIG_WPS */
#ifdef ENABLE_80211U /* K60_PORTING */
...
Boolean hostapd_sae_pk_in_use(struct hostapd_bss_config *conf)
{
#ifdef CONFIG_SAE_PK
	struct sae_password_entry *pw;
