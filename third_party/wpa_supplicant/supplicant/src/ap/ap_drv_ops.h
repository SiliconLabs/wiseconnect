...
static inline void hostapd_sl_wpa_driver_wrapper(struct hostapd_data *hapd, unsigned int cmd, int *ret_val)
{
	if (hapd->driver->sl_wpa_driver) {
	  return hapd->driver->sl_wpa_driver(hapd, cmd, ret_val);
	}
}
#endif /* AP_DRV_OPS */
