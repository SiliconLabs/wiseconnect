...
#endif
		SL_PRINTF(WLAN_SUPP_FLUSHING_OLD_STATION_ENTRIES, WLAN_UMAC, LOG_INFO);
...
#endif
		SL_PRINTF(WLAN_SUPP_DEAUTHENTICATE_ALL_STATIONS, WLAN_UMAC, LOG_INFO);
...
#endif /* CONFIG_INTERWORKING */
#if UNUSED_FEAT_IN_SUPP_29 /* rrm related changes */
