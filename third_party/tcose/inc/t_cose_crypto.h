 ...
 */
enum t_cose_err_t t_cose_crypto_sig_size(int32_t cose_algorithm_id, struct t_cose_key signing_key, size_t *sig_size);
 ...
 */
void t_cose_crypto_hash_update(struct t_cose_crypto_hash *hash_ctx, struct q_useful_buf_c data_to_hash);
 ...
 *
 */
static bool t_cose_algorithm_is_rsassa_pss(int32_t cose_algorithm_id);
 ...
 */
static inline bool t_cose_check_list(int32_t cose_algorithm_id, const int32_t *list)
{
  while (*list) {
...
static inline bool t_cose_algorithm_is_ecdsa(int32_t cose_algorithm_id)
{
  ...
  static const int32_t ecdsa_list[] = { COSE_ALGORITHM_ES256,
#ifndef T_COSE_DISABLE_ES384
...
static inline bool t_cose_algorithm_is_rsassa_pss(int32_t cose_algorithm_id)
{
...
#endif
    0
  }; /* 0 is a reserved COSE alg ID and will never be used */
