 ...
 */
static inline enum t_cose_err_t t_cose_sign1_verify_detached(struct t_cose_sign1_verify_ctx *context,
 ...
 */
static inline void t_cose_sign1_verify_init(struct t_cose_sign1_verify_ctx *me, uint32_t option_flags)
{
...
static inline void t_cose_sign1_set_verification_key(struct t_cose_sign1_verify_ctx *me,
                                                     struct t_cose_key verification_key)
{
  me->verification_key = verification_key;
}

static inline void t_cose_sign1_verify_set_auxiliary_buffer(struct t_cose_sign1_verify_ctx *me,
                                                            struct q_useful_buf auxiliary_buffer)
{
#ifndef T_COSE_DISABLE_EDDSA
...
static inline size_t t_cose_sign1_verify_auxiliary_buffer_size(struct t_cose_sign1_verify_ctx *me)
{
#ifndef T_COSE_DISABLE_EDDSA
...
static inline uint64_t t_cose_sign1_get_nth_tag(const struct t_cose_sign1_verify_ctx *context, size_t n)
{
...
static inline enum t_cose_err_t t_cose_sign1_verify(struct t_cose_sign1_verify_ctx *me,
                                                    struct q_useful_buf_c sign1,
                                                    struct q_useful_buf_c *payload,
                                                    struct t_cose_parameters *parameters)
{
...
static inline enum t_cose_err_t t_cose_sign1_verify_aad(struct t_cose_sign1_verify_ctx *me,
                                                        struct q_useful_buf_c cose_sign1,
                                                        struct q_useful_buf_c aad,
                                                        struct q_useful_buf_c *payload,
                                                        struct t_cose_parameters *parameters)
...
static inline enum t_cose_err_t t_cose_sign1_verify_detached(struct t_cose_sign1_verify_ctx *me,
                                                             struct q_useful_buf_c cose_sign1,
                                                             struct q_useful_buf_c aad,
                                                             struct q_useful_buf_c detached_payload,
                                                             struct t_cose_parameters *parameters)
{
  return t_cose_sign1_verify_internal(me, cose_sign1, aad, &detached_payload, parameters, true);
}
