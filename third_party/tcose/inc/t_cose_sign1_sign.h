 ...
 */
static inline void t_cose_sign1_set_content_type_uint(struct t_cose_sign1_sign_ctx *context, uint16_t content_type);
 ...
 */
static inline void t_cose_sign1_set_content_type_tstr(struct t_cose_sign1_sign_ctx *context, const char *content_type);
 ...
 * COSE message.
 */
static inline enum t_cose_err_t t_cose_sign1_encode_signature_aad(struct t_cose_sign1_sign_ctx *context,
                                                                  struct q_useful_buf_c aad,
                                                                  QCBOREncodeContext *cbor_encode_ctx);
 ...
 */
static inline void t_cose_sign1_sign_init(struct t_cose_sign1_sign_ctx *me,
                                          uint32_t option_flags,
                                          int32_t cose_algorithm_id)
{
...
static inline void t_cose_sign1_set_signing_key(struct t_cose_sign1_sign_ctx *me,
                                                struct t_cose_key signing_key,
                                                struct q_useful_buf_c kid)
{
  me->kid         = kid;
...
static inline void t_cose_sign1_sign_set_auxiliary_buffer(struct t_cose_sign1_sign_ctx *me,
                                                          struct q_useful_buf auxiliary_buffer)
{
#ifndef T_COSE_DISABLE_EDDSA
...
static inline size_t t_cose_sign1_sign_auxiliary_buffer_size(struct t_cose_sign1_sign_ctx *me)
{
#ifndef T_COSE_DISABLE_EDDSA
...
static inline enum t_cose_err_t t_cose_sign1_encode_parameters(struct t_cose_sign1_sign_ctx *context,
                                                               QCBOREncodeContext *cbor_encode_ctx)
{
  return t_cose_sign1_encode_parameters_internal(context, false, cbor_encode_ctx);
}
...
static inline enum t_cose_err_t t_cose_sign1_sign_aad(struct t_cose_sign1_sign_ctx *me,
                                                      struct q_useful_buf_c aad,
                                                      struct q_useful_buf_c payload,
                                                      struct q_useful_buf out_buf,
                                                      struct q_useful_buf_c *result)
{
  return t_cose_sign1_sign_aad_internal(me, false, aad, payload, out_buf, result);
}

static inline enum t_cose_err_t t_cose_sign1_sign(struct t_cose_sign1_sign_ctx *me,
                                                  struct q_useful_buf_c payload,
                                                  struct q_useful_buf out_buf,
                                                  struct q_useful_buf_c *result)
{
  return t_cose_sign1_sign_aad_internal(me, false, payload, NULL_Q_USEFUL_BUF_C, out_buf, result);
}

static inline enum t_cose_err_t t_cose_sign1_sign_detached(struct t_cose_sign1_sign_ctx *me,
                                                           struct q_useful_buf_c aad,
                                                           struct q_useful_buf_c detached_payload,
                                                           struct q_useful_buf out_buf,
                                                           struct q_useful_buf_c *result)
{
  return t_cose_sign1_sign_aad_internal(me, true, detached_payload, aad, out_buf, result);
}

static inline enum t_cose_err_t t_cose_sign1_encode_signature_aad(struct t_cose_sign1_sign_ctx *me,
                                                                  struct q_useful_buf_c aad,
                                                                  QCBOREncodeContext *cbor_encode_ctx)
{
  return t_cose_sign1_encode_signature_aad_internal(me, aad, NULL_Q_USEFUL_BUF_C, cbor_encode_ctx);
}

static inline enum t_cose_err_t t_cose_sign1_encode_signature(struct t_cose_sign1_sign_ctx *me,
                                                              QCBOREncodeContext *cbor_encode_ctx)
{
  return t_cose_sign1_encode_signature_aad_internal(me, NULL_Q_USEFUL_BUF_C, NULL_Q_USEFUL_BUF_C, cbor_encode_ctx);
}

#ifndef T_COSE_DISABLE_CONTENT_TYPE
static inline void t_cose_sign1_set_content_type_uint(struct t_cose_sign1_sign_ctx *me, uint16_t content_type)
{
  me->content_type_uint = content_type;
}

static inline void t_cose_sign1_set_content_type_tstr(struct t_cose_sign1_sign_ctx *me, const char *content_type)
{
