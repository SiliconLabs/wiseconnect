 ...
 */
enum t_cose_err_t short_circuit_sig_size(int32_t cose_algorithm_id, size_t *sig_size)
{
 ...
 * See documentation in t_cose_short_circuit.h
 */
enum t_cose_err_t short_circuit_sign(int32_t cose_algorithm_id,
                                     ...
                                     struct q_useful_buf_c *signature)
{
  ...
  for (array_indx = 0; array_indx < sig_size; array_indx += hash_to_sign.len) {
    ...
    memcpy((uint8_t *)signature_buffer.ptr + array_indx, hash_to_sign.ptr, amount_to_copy);
  }
 ...
 * See documentation in t_cose_short_circuit.h
 */
enum t_cose_err_t t_cose_crypto_short_circuit_verify(struct q_useful_buf_c hash_to_verify,
                                                     struct q_useful_buf_c signature)
{
