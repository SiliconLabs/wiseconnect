...
tls_server = wrap_socket(server_socket, ssl_version=PROTOCOL_TLSv1_2, cert_reqs=CERT_NONE, server_side=True, keyfile='server-key.pem', certfile='server-cert.pem')
