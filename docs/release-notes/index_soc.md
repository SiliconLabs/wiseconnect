# **WiSeConnect3\_SDK\_3.1.3 Matter Hotfix SoC Release Notes**
...
- **Enhancements**
  - None
- **Fixed Issues**
  - Configured NWP ref clock always on (40MHz XTAL)
...
## **Known Issues of WiSeConnect3\_SDK\_3.1.3 matter hotfix Release**

### **MCU**

- Occasionally observing below issues with asynchronous M4-TA frequent sleep-wakeups, 
  - Dead-lock issue with FreeRTOS in long run
  - Observed exceptions in long run
  - M4 is not coming out of sleep in the long run
...
- Sleep current will be 600uA as XTAL is always on
