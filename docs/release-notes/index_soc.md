# **WiSeConnect3\_SDK\_3.4.0-hotfix.3.1 SoC Release Notes**
...
|SDK Version|3\.4.0-hotfix.3.1|
|Firmware Version|<p>Standard: 1711.2.13.3.0.0.13</p><p>Lite Wireless: 1711.2.13.3.0.2.13</p>|
|GSDK/SiSDK Version|SiSDK 2024.12.0|
|Studio Version|5\.10.0.0|
|Release Package Name|WiSeConnect3\_SDK\_3.4.0-hotfix.3.1|
...
- SiWx917 release consists of two components:
  - SiWx91x Connectivity Firmware:
    - Standard Wireless Firmware - SiWx917 Firmware Binary available as SiWG917-B.2.13.3.0.0.13.rps
    - Lite Wireless Firmware - SiWx917 Firmware Binary is available as SiWG917-B.2.13.3.0.2.13.rps, this image is with reduced features for parts with SiWG917M110LGTBA OPN. 
...
## **Changes in this release compared to WiSeConnect3\_SDK\_3.4.0-hotfix.2.1 Release**
...
### **SDK**
  ...
  - Host Rx buffers are freed gracefully during data_read request and remote terminate scenarios.
  - Fixed issue of double memory freeing that occurs in IPv4 config failure path.

### **Wi-Fi/Network Stack**

  - Resolved instability issues with various commands sent in concurrent mode.
  - Fixed an issue where the firmware incorrectly maintained the socket state as connected after a third-party client disconnects, preventing the socket from re-entering listening mode.
  - Resolved an issue causing the Wi-Fi client interface to fail with 0x3 error in concurrent mode.
...
- It is recommended to disable rejoin on the station when AP sockets are being used in concurrent mode.
...
## **Known Issues of WiSeConnect3\_SDK\_3.4.0-hotfix.3.1 Release**
