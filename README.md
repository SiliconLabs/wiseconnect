...
The release notes for this release are located at: [Wi-Fi 6 + BLE (WiSeConnect 3) SDK Version 3.5.3 - Release Notes](https://docs.silabs.com/wiseconnect/3.5.3/sisdk-wifi-release-notes/).
...
## Documentation
An archive of all documents associated with the latest release of WiSeConnect™ 3 SDK can be found in [Releases](https://github.com/SiliconLabs/wiseconnect/releases). The online WiSeConnect 3 SDK documentation is available [here](https://docs.silabs.com/wiseconnect/3.5.3).

### Software Reference

  - See the [Getting Started](https://docs.silabs.com/wiseconnect/3.5.3/wiseconnect-getting-started) section to run your first example.
  - See the [Examples](https://docs.silabs.com/wiseconnect/3.5.3/wiseconnect-examples) section to explore all the available examples.
  - See our [Migration Guide](https://docs.silabs.com/wiseconnect/3.5.3/wiseconnect-developers-guide-migr-guides-overview/migrating-from-v3-5-1) for information on porting your WiSeConnect v3.5.1 application to WiSeConnect v3.5.3
