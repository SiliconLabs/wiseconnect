...
- **[SLT-CLI (v1.1.0+)](https://www.silabs.com/software-and-tools/simplicity-studio/silicon-labs-tool)** – a standalone command-line tool
- **[Simplicity Installer (v1.1.0+)](https://www.silabs.com/software-and-tools/simplicity-studio?tab=getting-started)** – a graphical installer that integrates SLT-CLI functionality
