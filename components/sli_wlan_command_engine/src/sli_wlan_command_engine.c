...
sl_status_t sli_wifi_command_engine_init(void)
{
  ...
  status =
    sli_async_event_handler_init(&sli_wifi_event_handler,
                                 (const sli_async_event_handler_configuration_t *)&sli_wifi_async_event_handler_config);
...
sl_status_t sli_wifi_command_engine_deinit(void)
{
  ...
  status = sli_async_event_handler_deinit(&sli_wifi_event_handler);
  VERIFY_STATUS_AND_RETURN(status);
