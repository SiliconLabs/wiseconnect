 ...
 */
typedef struct {
  sl_slist_node_t node;                 ///< Node for queueing the packet
...
typedef struct {
  ...
  sli_async_event_handler_t *async_response_event_handler;            ///< Asynchronous response event handler
...
typedef struct {
  ...
  sli_async_event_handler_t *error_event_handler;                            ///< Error event handler
...
typedef struct {
  ...
  uint32_t event;                    ///< Event flags for frame handling
