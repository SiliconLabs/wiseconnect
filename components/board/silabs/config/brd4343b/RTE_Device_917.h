 ...
 * $Revision:    V2.4.4
 *
 * Project:      RTE Device Configuration for Si91x 2.0 B0 BRD4343B
 * -------------------------------------------------------------------------- */
...
//   <o> I2S1_SCLK Pin <0=>P0_3 <1=>P0_7 <2=>P0
/*I2S1 PINS*/
#ifdef SLI_SI91X_MCU_CONFIG_RADIO_BOARD_BASE_VER
...
#define SENSOR_ENABLE_GPIO_PORT RTE_GPIO_3_PORT
#define SENSOR_ENABLE_GPIO_PIN  RTE_GPIO_3_PIN
