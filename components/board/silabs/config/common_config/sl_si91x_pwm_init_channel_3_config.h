...
// <<< sl:start pin_tool >>>
// <pwm signal=H4,L4,FAULTA,FAULTB,TMR_EXT_TRIG_1,TMR_EXT_TRIG_2> SL_PWM_CHANNEL3
// $[PWM_SL_PWM_CHANNEL3]
#ifndef SL_PWM_CHANNEL3_PERIPHERAL
#define SL_PWM_CHANNEL3_PERIPHERAL PWM
#endif

// PWM H4 on ULP_GPIO_7/GPIO_71
#ifndef SL_PWM_CHANNEL3_H4_PORT
#define SL_PWM_CHANNEL3_H4_PORT 0
#endif
#ifndef SL_PWM_CHANNEL3_H4_PIN
#define SL_PWM_CHANNEL3_H4_PIN 7
#endif
#ifndef SL_PWM_CHANNEL3_H4_LOC
#define SL_PWM_CHANNEL3_H4_LOC 1
#endif

// PWM L4 on ULP_GPIO_6/GPIO_70
#ifndef SL_PWM_CHANNEL3_L4_PORT
#define SL_PWM_CHANNEL3_L4_PORT 0
#endif
#ifndef SL_PWM_CHANNEL3_L4_PIN
#define SL_PWM_CHANNEL3_L4_PIN 6
#endif
#ifndef SL_PWM_CHANNEL3_L4_LOC
#define SL_PWM_CHANNEL3_L4_LOC 1
#endif

// PWM FAULTA on GPIO_25
#ifndef SL_PWM_CHANNEL3_FAULTA_PORT
#define SL_PWM_CHANNEL3_FAULTA_PORT 0
#endif
#ifndef SL_PWM_CHANNEL3_FAULTA_PIN
#define SL_PWM_CHANNEL3_FAULTA_PIN 25
#endif
#ifndef SL_PWM_CHANNEL3_FAULTA_LOC
#define SL_PWM_CHANNEL3_FAULTA_LOC 0
#endif

// PWM FAULTB on GPIO_26
#ifndef SL_PWM_CHANNEL3_FAULTB_PORT
#define SL_PWM_CHANNEL3_FAULTB_PORT 0
#endif
#ifndef SL_PWM_CHANNEL3_FAULTB_PIN
#define SL_PWM_CHANNEL3_FAULTB_PIN 26
#endif
#ifndef SL_PWM_CHANNEL3_FAULTB_LOC
#define SL_PWM_CHANNEL3_FAULTB_LOC 0
#endif

// PWM TMR_EXT_TRIG_1 on GPIO_27
#ifndef SL_PWM_CHANNEL3_TMR_EXT_TRIG_1_PORT
#define SL_PWM_CHANNEL3_TMR_EXT_TRIG_1_PORT 0
#endif
#ifndef SL_PWM_CHANNEL3_TMR_EXT_TRIG_1_PIN
#define SL_PWM_CHANNEL3_TMR_EXT_TRIG_1_PIN 27
#endif
#ifndef SL_PWM_CHANNEL3_TMR_EXT_TRIG_1_LOC
#define SL_PWM_CHANNEL3_TMR_EXT_TRIG_1_LOC 0
#endif

// PWM TMR_EXT_TRIG_2 on GPIO_28
#ifndef SL_PWM_CHANNEL3_TMR_EXT_TRIG_2_PORT
#define SL_PWM_CHANNEL3_TMR_EXT_TRIG_2_PORT 0
#endif
#ifndef SL_PWM_CHANNEL3_TMR_EXT_TRIG_2_PIN
#define SL_PWM_CHANNEL3_TMR_EXT_TRIG_2_PIN 28
#endif
#ifndef SL_PWM_CHANNEL3_TMR_EXT_TRIG_2_LOC
#define SL_PWM_CHANNEL3_TMR_EXT_TRIG_2_LOC 0
#endif
// [PWM_SL_PWM_CHANNEL3]$
// <<< sl:end pin_tool >>>
...
#if (SL_PWM_CHANNEL3_L4_LOC == 1)
#define SL_PWM_CHANNEL_3_PIN_L (SL_PWM_CHANNEL3_L4_PIN + 64)
#else
#define SL_PWM_CHANNEL_3_PIN_L SL_PWM_CHANNEL3_L4_PIN
#endif
#if (SL_PWM_CHANNEL3_H4_LOC == 1)
#define SL_PWM_CHANNEL_3_PIN_H (SL_PWM_CHANNEL3_H4_PIN + 64)
#else
#define SL_PWM_CHANNEL_3_PIN_H SL_PWM_CHANNEL3_H4_PIN
#endif

#define SL_PWM_CHANNEL_3_PORT_L SL_PWM_CHANNEL3_L4_PORT
#define SL_PWM_CHANNEL_3_PORT_H SL_PWM_CHANNEL3_H4_PORT

#define SL_PWM_CHANNEL_3_MUX_L SL_SI91X_PWM_4L_MUX
#define SL_PWM_CHANNEL_3_MUX_H SL_SI91X_PWM_4H_MUX

#define SL_PWM_CHANNEL_3_PAD_L SL_SI91X_PWM_4L_PAD
#define SL_PWM_CHANNEL_3_PAD_H SL_SI91X_PWM_4H_PAD

// PWM Fault Pin set resolution
#if (SL_PWM_CHANNEL_3_EVENT == 0)
#define SL_PWM_CHANNEL_3_PORT SL_PWM_CHANNEL3_FAULTA_PORT
...
#define SL_PWM_CHANNEL_3_PORT SL_PWM_CHANNEL3_FAULTB_PORT
#if (SL_PWM_CHANNEL3_FAULTB_LOC == 0)
...
#if ((SL_PWM_CHANNEL3_TMR_EXT_TRIG_1_LOC == 2) || (SL_PWM_CHANNEL3_TMR_EXT_TRIG_1_LOC == 3))
...
#define SL_PWM_CHANNEL_3_PORT SL_PWM_CHANNEL3_TMR_EXT_TRIG_2_PORT
#if (SL_PWM_CHANNEL3_TMR_EXT_TRIG_2_LOC == 2)
