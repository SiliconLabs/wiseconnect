 ...
 * $Revision:    V2.4.4
 *
 * Project:      RTE Device Configuration for Si91x 2.0 B0 BRD4343Q
 * -------------------------------------------------------------------------- */
...
#define SENSOR_ENABLE_GPIO_PORT RTE_ULP_GPIO_3_PORT
#define SENSOR_ENABLE_GPIO_PIN  RTE_ULP_GPIO_3_PIN
