/*******************************************************************************
 * @file  sl_si91x_psram_aps1604m_sqr_config.h
 * @brief
 *******************************************************************************
 * # License
 ...
 *
 ******************************************************************************/
#ifndef __SL_SI91X_PSRAM_APS1604M_SQR_CONFIG_H_
#define __SL_SI91X_PSRAM_APS1604M_SQR_CONFIG_H_
...
#define PSRAM_DEVICE_NAME APS1604M_SQR

#define PSRAM_DEVICE_DENSITY_MBIT 16

#define PSRAM_DEVICE_MFID 0x0D

#define PSRAM_DEVICE_KGD 0x5D

#define PSRAM_BURST_LEN_TOGGLE_SUPPORTED 1

#define PSRAM_HALF_SLEEP_SUPPORTED 0

#define PSRAM_ROW_BOUNDARY_CROSSING_SUPPORTED 1

#define PSRAM_NORMAL_READ_MAX_FREQ_MHZ 33

#define PSRAM_FAST_READ_MAX_FREQ_MHZ 144

#define PSRAM_DEFAULT_BURST_WRAP_SIZE 512

#define PSRAM_TOGGLE_BURST_WRAP_SIZE 32
...
#endif //__SL_SI91X_PSRAM_APS1604M_SQR_CONFIG_H_