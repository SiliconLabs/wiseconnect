...
#endif
  Cal->MCU_CAL_POWERGATE_REG_b.ENABLE_CALENDAR_COMBI = 1u;
  Cal->MCU_CAL_POWERGATE_REG_b.PG_EN_CALENDAR        = 1u;
  return;
}
...
{
  Cal->MCU_CAL_POWERGATE_REG_b.ENABLE_CALENDAR_COMBI = 0u;
  Cal->MCU_CAL_POWERGATE_REG_b.PG_EN_CALENDAR        = 0u;
  return;
}
