...
static sl_status_t rtt_read(void *context, void *buffer, size_t buffer_length, size_t *bytes_read);

/*******************************************************************************
 ******************************   VARIABLES   **********************************
 ******************************************************************************/

static sl_iostream_t sl_si91x_iostream_rtt = { .read = rtt_read, .write = rtt_write, .context = NULL };

sl_iostream_t *sl_si91x_iostream_rtt_handle = &sl_si91x_iostream_rtt;

sl_iostream_instance_info_t sl_si91x_iostream_instance_rtt_info = {
  .handle    = &sl_si91x_iostream_rtt,
  .name      = "rtt",
  .type      = SL_SI91X_IOSTREAM_TYPE_RTT_OUTPUT,
  .periph_id = 0,
  .init      = sl_si91x_iostream_rtt_init,
};
...
sl_status_t sl_si91x_iostream_rtt_init(void)
{
  ...
  status = sl_iostream_set_system_default(&sl_si91x_iostream_rtt);
  return status;
}
