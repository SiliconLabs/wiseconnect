...
typedef enum sl_veml6035_registers {
  ...
  SL_VEML6035_WH,       ///< Enumerator for High threshold window setting
  SL_VEML6035_WL,       ///< Enumerator for Low threshold window setting
  SL_VEML6035_PSM,      ///< Enumerator for Power Safe Mode control
  SL_VEML6035_ALS,      ///< Enumerator for ALS high resolution output data
