 ...
 * $Revision:    V2.4.4
 *
 * Project:      RTE Device Configuration for Si91x
 * -------------------------------------------------------------------------- */
...
#ifdef CHIP_917_6x6
#if((RTE_USART0_CLK_PORT_ID == 2)||(RTE_USART0_CLK_PORT_ID == 3))
...
#ifdef CHIP_917_6x6
#define RTE_USART0_TX_PORT_ID                   3
#if((RTE_USART0_TX_PORT_ID == 0)||(RTE_USART0_TX_PORT_ID ==2))
...
#ifdef CHIP_917_6x6
#define RTE_USART0_RX_PORT_ID                   0
#if((RTE_USART0_RX_PORT_ID == 2)||(RTE_USART0_RX_PORT_ID == 3))
...
#endif
#ifdef CHIP_917_6x6
#define RTE_IR_TX_PORT_ID                       2
#if((RTE_IR_TX_PORT_ID ==0 )||(RTE_IR_TX_PORT_ID ==1 ))
  #error "Invalid USART0 RTE_USART0_IR_TX_PIN Pin Configuration!"
#endif
#endif
...
#elif(RTE_RI_PORT_ID ==2)
#define RTE_USART0_RI_PORT                      0
#define RTE_USART0_RI_PIN                       68
...
#ifdef CHIP_917_6x6
#define RTE_USART0_DCD_PORT                     0
#define RTE_USART0_DCD_PIN                      29
#define RTE_USART0_DCD_MUX                      12
#define RTE_USART0_DCD_PAD                      0//no pad
#endif
...
#ifdef CHIP_917_6x6
#define RTE_UART1_TX_PORT_ID                       0
#if((RTE_UART1_TX_PORT_ID == 2)||(RTE_UART1_TX_PORT_ID == 4)||(RTE_UART1_TX_PORT_ID == 5))
  #error "Invalid UART1 RTE_UART1_TX_PIN Configuration!"
#endif
#endif
...
#define RTE_UART1_TX_PORT                       0
#define RTE_UART1_TX_PIN                        34
#define RTE_UART1_TX_MUX                        12
...
#if((RTE_UART1_RX_PORT_ID == 6))
  #error "Invalid UART1 RTE_UART1_RX_PIN Configuration!"
#endif
#endif

#ifdef CHIP_917_6x6
#define RTE_UART1_RX_PORT_ID                       0
#if((RTE_UART1_RX_PORT_ID == 2)||(RTE_UART1_RX_PORT_ID == 4)||(RTE_UART1_RX_PORT_ID == 5))
  #error "Invalid UART1 RTE_UART1_RX_PIN Configuration!"
#endif
#endif
...
#define RTE_UART1_RX_PORT                       0
#define RTE_UART1_RX_PIN                        33
#define RTE_UART1_RX_MUX                        12
...
#if((RTE_UART1_CTS_PORT_ID == 6))
  #error "Invalid UART1 RTE_UART1_CTS_PIN Configuration!"
#endif
#endif

#ifdef CHIP_917_6x6
#define RTE_UART1_CTS_PORT_ID                       6
#if((RTE_UART1_CTS_PORT_ID == 2)||(RTE_UART1_CTS_PORT_ID == 3)||(RTE_UART1_CTS_PORT_ID == 5))
  #error "Invalid UART1 RTE_UART1_CTS_PIN Configuration!"
#endif
#endif
...
#elif(RTE_UART1_CTS_PORT_ID ==6)
#define RTE_UART1_CTS_PORT                      0
#define RTE_UART1_CTS_PIN                       32
#define RTE_UART1_CTS_MUX                       12
#define RTE_UART1_CTS_PAD                       9
#else
...
#endif
#if((RTE_UART1_RTS_PORT_ID == 6))
  #error "Invalid UART1 RTE_UART1_RTS_PIN Configuration!"
#endif
#endif

#ifdef CHIP_917_6x6
#define RTE_UART1_RTS_PORT_ID                       6
#if((RTE_UART1_RTS_PORT_ID == 2)||(RTE_UART1_RTS_PORT_ID == 3)||(RTE_UART1_RTS_PORT_ID == 5))
  #error "Invalid UART1 RTE_UART1_RTS_PIN Configuration!"
#endif
#endif
...
#elif(RTE_UART1_RTS_PORT_ID ==6)
#define RTE_UART1_RTS_PORT                      0
#define RTE_UART1_RTS_PIN                       31
#define RTE_UART1_RTS_MUX                       12
#define RTE_UART1_RTS_PAD                       9
#else
...
//     <i> TX of ULPSS UART
#ifdef SLI_SI91X_MCU_CONFIG_RADIO_BOARD_VER2
...
//     <i> CTS of ULPSS UART
#define RTE_ULP_UART_CTS_PORT_ID                1
...
//     <i> RTS of ULPSS UART
#define RTE_ULP_UART_RTS_PORT_ID                1
...
#endif
#if((RTE_SSI_MASTER_MISO_PORT_ID == 3))
  #error "Invalid SSI RTE_SSI_MASTER_MISO_PIN Configuration!"
#endif
#endif

#ifdef CHIP_917_6x6
#define RTE_SSI_MASTER_MISO_PORT_ID                       3
#if((RTE_SSI_MASTER_MISO_PORT_ID == 0)||(RTE_SSI_MASTER_MISO_PORT_ID == 2))
  #error "Invalid SSI RTE_SSI_MASTER_MISO_PIN Configuration!"
#endif
#endif
...
#define  RTE_SSI_MASTER_MISO                 1
#define  RTE_SSI_MASTER_MISO_PORT            0
#define  RTE_SSI_MASTER_MISO_PIN             10
#define  RTE_SSI_MASTER_MISO_MODE            12
...
#ifdef CHIP_917_6x6
#if((RTE_SSI_MASTER_MOSI_PORT_ID == 2))
...
#ifdef CHIP_917_6x6
#if((RTE_SSI_MASTER_SCK_PORT_ID == 2))
...
#ifdef CHIP_917_6x6
#if((RTE_SSI_MASTER_CS0_PORT_ID == 2))
...
#ifdef CHIP_917_6x6
#if((RTE_SSI_SLAVE_MISO_PORT_ID == 3)||(RTE_SSI_SLAVE_MISO_PORT_ID == 4))
...
#ifdef CHIP_917_6x6
#define RTE_SSI_SLAVE_MOSI_PORT_ID           2
#if((RTE_SSI_SLAVE_MOSI_PORT_ID == 3)||(RTE_SSI_SLAVE_MOSI_PORT_ID == 4))
...
#ifdef CHIP_917_6x6
#if((RTE_SSI_SLAVE_SCK_PORT_ID == 3)||(RTE_SSI_SLAVE_SCK_PORT_ID == 4))
...
#ifdef CHIP_917_6x6
#if((RTE_SSI_SLAVE_CS_PORT_ID == 3)||(RTE_SSI_SLAVE_CS_PORT_ID == 4))
...
#ifdef SLI_SI91X_MCU_CONFIG_RADIO_BOARD_BASE_VER
#define RTE_SSI_ULP_MASTER_SCK_PORT_ID           1
#else
...
// CS0
#define RTE_SSI_ULP_MASTER_CS0_PORT_ID          0
...
#ifdef CHIP_917_6x6
#if((RTE_I2S0_SCLK_PORT_ID == 2)||(RTE_I2S0_SCLK_PORT_ID == 3))
...
#ifdef CHIP_917_6x6
#if((RTE_I2S0_WSCLK_PORT_ID == 2)||(RTE_I2S0_WSCLK_PORT_ID == 3))
...
#ifdef CHIP_917_6x6
#if((RTE_I2S0_DOUT0_PORT_ID == 2)||(RTE_I2S0_DOUT0_PORT_ID == 3))
...
#ifdef CHIP_917_6x6
#if((RTE_I2S0_DIN0_PORT_ID == 2)||(RTE_I2S0_DIN0_PORT_ID == 3))
  #error "Invalid USART0 RTE_I2S0_DIN0 pin Configuration!"
#endif
#endif
...
#ifdef CHIP_917_6x6
#define RTE_I2S0_DOUT1_PORT_ID                   1
#if((RTE_I2S0_DOUT1_PORT_ID == 2)||(RTE_I2S0_DOUT1_PORT_ID == 3))
...
#ifdef CHIP_917_6x6
#if((RTE_I2S0_DIN1_PORT_ID == 2)||(RTE_I2S0_DIN1_PORT_ID == 3))
...
#define RTE_I2S1_DOUT0_PORT_ID                 1
...
#if((RTE_I2C0_SCL_PORT_ID == 4))
  #error "Invalid I2C0 RTE_I2C0_SCL_PIN Configuration!"
#endif
#endif

#ifdef CHIP_917_6x6
#define RTE_I2C0_SCL_PORT_ID                       0
#if((RTE_I2C0_SCL_PORT_ID == 1)||(RTE_I2C0_SCL_PORT_ID == 2)||(RTE_I2C0_SCL_PORT_ID == 3))
  #error "Invalid I2C0 RTE_I2C0_SCL_PIN Configuration!"
#endif
#endif
...
#ifndef CHIP_917_6x6
#ifdef SLI_SI91X_MCU_CONFIG_RADIO_BOARD_BASE_VER
#define RTE_I2C0_SDA_PORT_ID            3
#else
#define RTE_I2C0_SDA_PORT_ID            0
#endif
#if((RTE_I2C0_SDA_PORT_ID == 4))
  #error "Invalid I2C0 RTE_I2C0_SDA Configuration!"
#endif	
#endif
#ifdef CHIP_917_6x6
#define RTE_I2C0_SDA_PORT_ID                       0
#if((RTE_I2C0_SDA_PORT_ID == 1)||(RTE_I2C0_SDA_PORT_ID == 2)||(RTE_I2C0_SDA_PORT_ID == 3))
  #error "Invalid I2C0 RTE_I2C0_SDA Configuration!"
#endif
#endif
...
#if((RTE_I2C1_SCL_PORT_ID == 7))
  #error "Invalid I2C1_SCL pin Configuration!"
#endif
#endif
#ifdef CHIP_917_6x6
#define RTE_I2C1_SCL_PORT_ID                       7
#if((RTE_I2C1_SCL_PORT_ID == 2)||(RTE_I2C1_SCL_PORT_ID == 3)||(RTE_I2C1_SCL_PORT_ID == 4)||(RTE_I2C1_SCL_PORT_ID == 5))
  #error "Invalid I2C1_SCL pin Configuration!"
#endif
#endif
...
#ifdef CHIP_917_6x6
#define RTE_I2C1_SDA_PORT_ID                       7
#if((RTE_I2C1_SDA_PORT_ID == 2)||(RTE_I2C1_SDA_PORT_ID == 3)||(RTE_I2C1_SDA_PORT_ID == 4)||(RTE_I2C1_SDA_PORT_ID == 5))
...
#ifdef CHIP_917_6x6
#define RTE_GSPI_MASTER_CLK_PORT_ID                  1
#if((RTE_GSPI_MASTER_CLK_PORT_ID == 2)||(RTE_GSPI_MASTER_CLK_PORT_ID == 3))
...
#if((RTE_GSPI_MASTER_CS0_PORT_ID == 2)||(RTE_GSPI_MASTER_CS0_PORT_ID == 3))
...
#ifdef CHIP_917_6x6
#define RTE_GSPI_MASTER_MOSI_PORT_ID                       1
#if((RTE_GSPI_MASTER_MOSI_PORT_ID == 0)||(RTE_GSPI_MASTER_MOSI_PORT_ID == 2)||(RTE_GSPI_MASTER_MOSI_PORT_ID == 3))
  #error "Invalid GSPI0 RTE_GSPI_MASTER_MOSI_PIN pin Configuration!"
#endif
#endif
...
#ifdef CHIP_917_6x6
#define RTE_GSPI_MASTER_MISO_PORT_ID                  1
#if((RTE_GSPI_MASTER_MISO_PORT_ID == 2)||(RTE_GSPI_MASTER_MISO_PORT_ID == 3))
...
#endif
#ifdef CHIP_917_6x6
#define RTE_SCT_IN_1_PORT_ID                  0
#if((RTE_SCT_IN_1_PORT_ID == 1))
...
#ifdef CHIP_917_6x6
#define RTE_SCT_IN_2_PORT_ID                  0
#if((RTE_SCT_IN_2_PORT_ID == 1))
  #error "Invalid RTE_SCT_IN_2_PIN pin Configuration!"
#endif
#endif
...
#ifdef CHIP_917_6x6
#define RTE_SCT_IN_3_PORT_ID                  0
#if((RTE_SCT_IN_3_PORT_ID == 1))
  #error "Invalid RTE_SCT_IN_3_PIN pin Configuration!"
#endif
#endif
...
#endif
#ifdef CHIP_917_6x6
#define RTE_SCT_OUT_4_PORT_ID                       1
...
#define RTE_SCT_OUT_4_PORT                    0
#define RTE_SCT_OUT_4_PIN                     68 
#define RTE_SCT_OUT_4_MUX                     13 
#define RTE_SCT_OUT_4_PAD                     26
#else
  #error "Invalid  RTE_SCT_OUT_4_PIN Pin Configuration!"
#endif
...
#define RTE_SCT_OUT_5_PIN                      69        
#define RTE_SCT_OUT_5_MUX                      13
#define RTE_SCT_OUT_5_PAD                      27
#else
  #error "Invalid  RTE_SCT_OUT_5_PIN Pin Configuration!"
#endif
...
#define RTE_SCT_OUT_7_PORT                    0
#define RTE_SCT_OUT_7_PIN                     71      
#define RTE_SCT_OUT_7_MUX                     13 
#define RTE_SCT_OUT_7_PAD                     29
#else
  #error "Invalid  RTE_SCT_OUT_7_PIN Pin Configuration!"
#endif
...
#ifdef CHIP_917_6x6
#define RTE_SIO_0_PORT_ID                 0
#if((RTE_SIO_0_PORT_ID == 2)||(RTE_SIO_0_PORT_ID == 3))
...
#ifdef CHIP_917_6x6
#define RTE_SIO_1_PORT_ID                 1
#if((RTE_SIO_1_PORT_ID == 2)||(RTE_SIO_1_PORT_ID == 3))
  #error "Invalid RTE_SIO_1_PIN Configuration!"
#endif
#endif
...
#if((RTE_SIO_2_PORT_ID == 2)||(RTE_SIO_2_PORT_ID == 3))
  #error "Invalid RTE_SIO_2_PIN Configuration!"
#endif
#endif        
...
#if((RTE_SIO_3_PORT_ID == 2)||(RTE_SIO_3_PORT_ID == 3))
  #error "Invalid RTE_SIO_3_PIN Configuration!"
#endif
#endif 
...
#define RTE_SIO_7_PORT_ID                 1
  ...
  #error "Invalid RTE_SIO_7_PIN Configuration!"
#endif
#endif
#if(RTE_SIO_7_PORT_ID == 0)
...
#else
#define RTE_PWM_1H_PORT_ID                 1
#endif
#endif
#ifdef CHIP_917_6x6
#define RTE_PWM_1H_PORT_ID                       0
#if((RTE_PWM_1H_PORT_ID == 1))
  #error "Invalid RTE_PWM_1H_PIN Configuration!"
#endif
#endif
...
#ifdef CHIP_917_6x6
#define RTE_PWM_1L_PORT_ID                   0
#if((RTE_PWM_1L_PORT_ID == 1))
  #error "Invalid RTE_PWM_1L_PIN Configuration!"
#endif
#endif
...
#elif(RTE_PWM_2H_PORT_ID == 2)
#define RTE_PWM_2H_PORT                    0
#define RTE_PWM_2H_PIN                     69
...
#elif(RTE_PWM_2L_PORT_ID == 2)
#define RTE_PWM_2L_PORT                    0
#define RTE_PWM_2L_PIN                     68    
...
#ifdef CHIP_917_6x6
#if((RTE_PWM_TMR_EXT_TRIG_1_PORT_ID == 1)||(RTE_PWM_TMR_EXT_TRIG_1_PORT_ID == 3))
...
#ifdef CHIP_917_6x6
#if((RTE_PWM_TMR_EXT_TRIG_2_PORT_ID == 1))
...
#if((RTE_QEI_DIR_PORT_ID == 7)||(RTE_QEI_DIR_PORT_ID == 6))
  #error "Invalid RTE_QEI_DIR_PIN pin Configuration!"
#endif
#endif
#ifdef CHIP_917_6x6
#define RTE_QEI_DIR_PORT_ID                       6
#if((RTE_QEI_DIR_PORT_ID == 1)||(RTE_QEI_DIR_PORT_ID == 2)|| (RTE_QEI_DIR_PORT_ID == 3)||(RTE_QEI_DIR_PORT_ID == 5))
  #error "Invalid RTE_QEI_DIR_PIN pin Configuration!"
#endif
#endif
...
#ifndef CHIP_917_6x6
#define RTE_QEI_IDX_PORT_ID                 4   
#if((RTE_QEI_IDX_PORT_ID == 7)||(RTE_QEI_IDX_PORT_ID == 6))
  #error "Invalid RTE_QEI_IDX_PIN pin Configuration!"
#endif
#endif
#ifdef CHIP_917_6x6
#define RTE_QEI_IDX_PORT_ID                       6	
#if((RTE_QEI_IDX_PORT_ID == 1) || (RTE_QEI_IDX_PORT_ID == 2)||(RTE_QEI_IDX_PORT_ID == 3)||(RTE_QEI_IDX_PORT_ID == 5))
  #error "Invalid RTE_QEI_IDX_PIN pin Configuration!"
#endif
#endif
...
#ifndef CHIP_917_6x6 
#ifdef SLI_SI91X_MCU_CONFIG_RADIO_BOARD_BASE_VER
#define RTE_QEI_PHA_PORT_ID                 4     
#else
#define RTE_QEI_PHA_PORT_ID                 5     
#endif
#if((RTE_QEI_PHA_PORT_ID == 7)||(RTE_QEI_PHA_PORT_ID == 6))
  #error "Invalid RTE_QEI_PHA_PIN pin Configuration!"
#endif
#endif
#ifdef CHIP_917_6x6
#define RTE_QEI_PHA_PORT_ID                       6
#if((RTE_QEI_PHA_PORT_ID == 1)||(RTE_QEI_PHA_PORT_ID == 2)||(RTE_QEI_PHA_PORT_ID == 3)||(RTE_QEI_PHA_PORT_ID == 5))
  #error "Invalid RTE_QEI_PHA_PIN pin Configuration!"
#endif
#endif
...
#endif
#if((RTE_QEI_PHB_PORT_ID == 6) || (RTE_QEI_PHB_PORT_ID == 7))
  #error "Invalid RTE_QEI_PHB_PIN Configuration!"
#endif
#endif
#ifdef CHIP_917_6x6
#define RTE_QEI_PHB_PORT_ID                 6
#if((RTE_QEI_PHB_PORT_ID == 1) || (RTE_QEI_PHB_PORT_ID == 2)||(RTE_QEI_PHB_PORT_ID == 3)||(RTE_QEI_PHB_PORT_ID == 5) )
  #error "Invalid RTE_QEI_PHB_PIN Configuration!"
#endif
#endif
