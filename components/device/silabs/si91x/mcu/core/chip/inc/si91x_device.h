  ...
  union {
    ...
    struct {
      ...
      __IOM unsigned int MCU_ULP_32KHZ_XTAL_CLK_EN_b : 1;     /*!< [18..18] Enables ULP
                                                         32KHz Xtal Clock. */
      __IOM unsigned int MCU_ULP_32MHZ_RC_CLK_EN_b : 1;       /*!< [19..19] Enables ULP
                                                         32MHz RC Clock.   */
  ...
  union {
    ...
    struct {
      ...
      __IOM unsigned int ULP_20MHZ_RO_CLK_EN_PROG_b : 1;   /*!< [4..4] Static Clock enable to
                                          ...
                                          one(set) then clock enable else not
                                          enable.                            */
      __IOM unsigned int ULP_32MHZ_RC_CLK_EN_PROG_b : 1;   /*!< [5..5] Static Clock enable to
...
typedef struct { /*!< (@ 0x24043800) AUX_ADC_DAC_COMP Structure */
  ...
  union {
    ...
    struct {
      ...
      __IOM unsigned int ENDIFF : 1;                   /*!< [11..11] Control to the Aux ADC TODO */
