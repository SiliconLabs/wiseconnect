 ...
 * 
 * @details 
 *  Device should contain a valid activation code (AC) in MBR. The activation code and the startup 
 *  data are used to reconstruct the digital fingerprint. 
 * 
 * @return 
 ...
 * 
 * @details
 *  The digital fingerprint generated during the Enroll/Start operations is used to generate a key code (KC) that defines a unique intrinsic key. 
...
/**
 * @brief Encrypts data using IV, key provided depending on mode
 * 
 * @details
 ...
 * @param[in]  data_size      Size of data in bytes (value that should be multiples of key size in range 16 - 1408)
...
/**
 * @brief Decrypts data using IV, Key provided depending on mode
 * 
 * @details
...
/**
 * @brief Calculates MAC for given data using AES-CBC mode
 * 
 * @details
