...
DEFINE_FAKE_VALUE_FUNC1(sl_si91x_host_timestamp_t, sl_si91x_host_elapsed_time, uint32_t);
...
DEFINE_FAKE_VALUE_FUNC4(sl_status_t,
                        ...
                        uint32_t,
                        uint32_t);
DEFINE_FAKE_VALUE_FUNC0(bool, sli_is_tcp_auto_close_enabled);
...
DEFINE_FAKE_VALUE_FUNC1(osMutexId_t, osMutexNew, const osMutexAttr_t *);
DEFINE_FAKE_VALUE_FUNC1(osStatus_t, osEventFlagsDelete, osEventFlagsId_t);
DEFINE_FAKE_VALUE_FUNC2(osStatus_t, osMutexAcquire, osMutexId_t, uint32_t);
...
DEFINE_FAKE_VALUE_FUNC1(osStatus_t, osMutexDelete, osMutexId_t);
DEFINE_FAKE_VALUE_FUNC1(osStatus_t, osMutexRelease, osMutexId_t);
...
DEFINE_FAKE_VALUE_FUNC1(uint16_t, sli_wifi_get_wifi_frame_status, const sl_wifi_system_packet_t *);
DEFINE_FAKE_VALUE_FUNC0(sl_wifi_operation_mode_t, sli_wifi_get_opermode);
DEFINE_FAKE_VALUE_FUNC1(uint8_t, sli_wifi_get_vap_id_from_operation_mode, const sl_wifi_system_packet_t *);
DEFINE_FAKE_VALUE_FUNC2(sl_status_t, sli_net_get_vap_for_ip_version, uint8_t *, sl_ip_address_type_t);
...
void *sli_si91x_wifi_command_engine_rx_packet_handler;
sli_command_engine_t sli_wifi_command_engine;
sli_queue_t cmd_queues[5];
