...
typedef enum {
  ...
  SL_SI91X_WIFI_BTR_REQ_SET_CHANNEL      = 0x7A,
  SL_SI91X_WIFI_BTR_REQ_PEER_LIST_UPDATE = 0x8B,
  SL_SI91X_WIFI_BTR_REQ_CONFIG_PARAMS    = 0x8C,
  SL_SI91X_WIFI_BTR_REQ_SET_MCAST_FILTER = 0x8D,
  SL_SI91X_WIFI_BTR_REQ_FLUSH_DATA_Q     = 0x8E,
...
typedef enum {
  ...
  SL_SI91X_WIFI_BTR_RSP_SET_CHANNEL      = 0x7A,
  SL_SI91X_WIFI_BTR_RSP_PEER_LIST_UPDATE = 0x8B,
  SL_SI91X_WIFI_BTR_RSP_CONFIG_PARAMS    = 0x8C,
  SL_SI91X_WIFI_BTR_RSP_SET_MCAST_FILTER = 0x8D,
  SL_SI91X_WIFI_BTR_RSP_FLUSH_DATA_Q     = 0x8E,
  SL_SI91X_WIFI_BTR_TX_DATA_STATUS       = 0x3D,
