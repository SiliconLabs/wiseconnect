...
#define WAKE_INDICATOR_PIN_GPIO_Port GPIOA
#define WAKE_INDICATOR_PIN_Pin       GPIO_PIN_10

#define SLEEP_CONFIRM_PIN_GPIO_Port  GPIOB
#define SLEEP_CONFIRM_PIN_Pin        GPIO_PIN_5
