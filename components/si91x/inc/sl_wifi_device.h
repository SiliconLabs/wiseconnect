...
/** \addtogroup SI91X_FEATURE_BITMAP si91x_feature_bit_map
 * @{ */
/*=========================================================================*/
...
/** \addtogroup SI91X_TCP_IP_FEATURE_BITMAP si91x_tcp_ip_feature_bit_map
 * @{ */
/*=========================================================================*/
...
/** \addtogroup SI91X_CUSTOM_FEATURE_BITMAP si91x_custom_feature_bit_map
 * @{ */
/*=========================================================================*/
...
/** \addtogroup SI91X_EXTENDED_CUSTOM_FEATURE_BITMAP si91x_extended_custom_feature_bit_map
 * @{ */
/*=========================================================================*/
...
#define RAM_LEVEL_NWP_BASIC_MCU_ADV      SL_SI91X_EXT_FEAT_352K_M4SS_320K

// To enable 416K memory for TA
#define SL_SI91X_EXT_FEAT_416K_M4SS_256K BIT(21)
#define RAM_LEVEL_NWP_MEDIUM_MCU_MEDIUM  SL_SI91X_EXT_FEAT_416K_M4SS_256K

// To enable 480K memory for TA
#define SL_SI91X_EXT_FEAT_480K_M4SS_192K BIT(20)
#define RAM_LEVEL_NWP_ADV_MCU_BASIC      SL_SI91X_EXT_FEAT_480K_M4SS_192K

#ifndef RSI_M4_INTERFACE
// To enable 672K memory for TA; only supported in WiSeConnect
#define SL_SI91X_EXT_FEAT_672K_M4SS_0K (BIT(20) | BIT(21))
#define RAM_LEVEL_NWP_ALL_MCU_ZERO     SL_SI91X_EXT_FEAT_672K_M4SS_0K
#endif
...
#define RAM_LEVEL_NWP_MEDIUM_MCU_MEDIUM  SL_SI91X_EXT_FEAT_448K_M4SS_256K

/// To enable 512K memory for TA
#define SL_SI91X_EXT_FEAT_512K_M4SS_192K BIT(20)
#define RAM_LEVEL_NWP_ADV_MCU_BASIC      SL_SI91X_EXT_FEAT_512K_M4SS_192K

#ifndef RSI_M4_INTERFACE
// To enable 704K memory for TA; only supported in NCP
#define SL_SI91X_EXT_FEAT_704K_M4SS_0K (BIT(20) | BIT(21))
#define RAM_LEVEL_NWP_ALL_MCU_ZERO     SL_SI91X_EXT_FEAT_704K_M4SS_0K
#endif

#endif // CHIP_917

#if !(defined CHIP_917) && !(defined CHIP_917B0) // defaults
...
#define RAM_LEVEL_NWP_MEDIUM_MCU_MEDIUM SL_SI91X_EXT_FEAT_256K_MODE

/// To enable 320K memory for TA
#define SL_SI91X_EXT_FEAT_320K_MODE BIT(20)
#define RAM_LEVEL_NWP_ADV_MCU_BASIC SL_SI91X_EXT_FEAT_320K_MODE

/// To enable 384K memory for TA
#define SL_SI91X_EXT_FEAT_384K_MODE (BIT(20) | BIT(21))
#define RAM_LEVEL_NWP_ALL_MCU_ZERO  SL_SI91X_EXT_FEAT_384K_MODE
...
/** \addtogroup SI91X_EXTENDED_TCP_IP_FEATURE_BITMAP si91x_extended_tcp_ip_feature_bit_map
 * @{ */
/*=========================================================================*/
...
/** \addtogroup SI91X_BT_FEATURE_BITMAP si91x_bt_feature_bit_map
 * @{ */
/*=========================================================================*/
...
/** \addtogroup SI91X_BLE_FEATURE_BITMAP si91x_ble_feature_bit_map
 * @{ */
/*=========================================================================*/
// BLE feature bit map
/*=========================================================================*/
...
/** \addtogroup SI91X_EXTENDED_BLE_CUSTOM_FEATURE_BITMAP si91x_extended_ble_custom_feature_bit_map
 * @{ */
/*=========================================================================*/
...
/** \addtogroup SI91X_BURN_TARGET_OPTIONS si91x_burn_target_options
 * @{ */
/// Burn data to EFUSE
...
/** \addtogroup SI91X_CALIBRATION_FLAGS si91x_calibration_flags
 * @{ */
...
/** \addtogroup SI91X_DTIM_ALIGNMENT_TYPES si91x_dtim_alignment_types
 * @{ */
...
///< Device configuration for 91x
typedef struct {
  uint8_t boot_option;                       ///< Boot option, @ref SI91X_LOAD_IMAGE_TYPES
  sl_mac_address_t *mac_address;             ///< mac address
  sl_si91x_band_mode_t band;                 ///< Si91x Wi-Fi band
  sl_si91x_region_code_t region_code;        ///< Si91x region code
  sl_si91x_boot_configuration_t boot_config; ///< Si91x boot configuration
