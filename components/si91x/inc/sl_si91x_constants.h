 ...
 * @{
 * \addtogroup SI91X_LOAD_IMAGE_TYPES si91x_load_image_types
 * @{ */
// Load Image types
/// Load NWP firmware
...
/**
 * \addtogroup SI91X_TLS_DEFINE si91x_tls_defines
 * @{ */
/*=========================================================================*/
...
/** 
 * \addtogroup SI91X_HTTP_CLIENT_DEFINE si91x_http_client_defines
 * @{ */
/*=========================================================================*/
...
/** @} */
/** @} */ // end of group SL_SI91X_CONSTANTS
...
typedef enum {
  ...
  SI91X_AP_NULL_BASED_KEEP_ALIVE = 3
} si91x_ap_keepalive_type_t;
