...
typedef enum {
  ...
  SL_GPIO_INTERRUPT_RISING_EDGE  = (1 << 1), ///< interrupt when rising edge is detected
  SL_GPIO_INTERRUPT_FALLING_EDGE = (1 << 2), ///< interrupt when falling edge is detected
