...
#define SL_GPIO_VALIDATE_PIN(pin_num)                 ((pin_num > 57) ? 0 : 1)  ///< Validate GPIO HP pin number
...
#define SL_GPIO_VALIDATE_MODE_PARAMETER(mode)         ((mode) > 7 ? 0 : 1)      ///< Validate UULP, ULP mode
#define SL_GPIO_VALIDATE_UULP_INTR(interrupt)         ((interrupt) > 4 ? 0 : 1) ///< Validate UULP interrupt
