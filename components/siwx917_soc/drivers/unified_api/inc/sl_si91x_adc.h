 ...
 *
 * @pre \ref sl_si91x_adc_configure_clock
 * @pre \ref sl_si91x_adc_init
 * @pre \ref sl_si91x_adc_configure_reference_voltage
 * @pre \ref sl_si91x_adc_channel_set_configuration
 *
 ...
 * @pre \ref sl_si91x_adc_init
 * @pre \ref sl_si91x_adc_configure_reference_voltage
 * @pre \ref sl_si91x_adc_configure_ping_pong_memory_address
 *
 * @param[in]  uint8_t channel_num   :  Channel number
 * @return status 0 if successful, else error code
 *         \ref SL_STATUS_OK (0x0000) - Success \n
 ...
 * @pre \ref sl_si91x_adc_configure_reference_voltage
 * @pre \ref sl_si91x_adc_configure_ping_pong_memory_address
 * @pre \ref sl_si91x_adc_enable_ping_pong
 * @pre \ref sl_si91x_adc_start
 *
 * @param[in]  uint8_t channel_num   :  Channel number
 * @return status 0 if successful, else error code
 ...
 * @pre \ref sl_si91x_adc_init
 * @pre \ref sl_si91x_adc_configure_reference_voltage
 * @pre \ref sl_si91x_adc_channel_enable
 *
 * @param[in]  uint8_t channel_num   :  Channel number
 * @return status 0 if successful, else error code
 *         \ref SL_STATUS_OK (0x0000) - Success \n
 ...
 * @pre \ref sl_si91x_adc_configure_reference_voltage
 * @pre \ref sl_si91x_adc_channel_enable
 * @pre \ref sl_si91x_adc_internal_per_channel_dma_enable
 * @pre \ref sl_si91x_adc_start
 *
 * @param[in]  uint8_t channel_num   :  Channel number
 * @return status 0 if successful, else error code
 ...
 * @pre \ref sl_si91x_adc_configure_clock
 * @pre \ref sl_si91x_adc_init
 * @pre \ref sl_si91x_adc_power_control
 * @pre \ref sl_si91x_adc_configure_reference_voltage
 *
 ...
 * @pre \ref sl_si91x_adc_channel_set_configuration
 * @pre \ref sl_si91x_adc_start
 * @pre \ref sl_si91x_adc_read_data_static
 *
 * @param[in]  adc_config    : ADC operation configuration structure variable.
 * @param[in]  uint8_t channel_num   :  Channel number
 * @return status 0 if successful, else error code
