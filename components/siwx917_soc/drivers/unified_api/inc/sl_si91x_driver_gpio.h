 ...
 * @pre   \ref sl_si91x_gpio_driver_enable_pad_selection(), for HP instance
 * @pre   \ref sl_si91x_gpio_driver_enable_pad_receiver(), for HP instance
 * @pre   \ref sl_si91x_gpio_driver_enable_ulp_pad_receiver(), for ULP instance
 ...
 * @pre   \ref sl_si91x_gpio_driver_enable_clock()
 * @pre   \ref sl_si91x_gpio_driver_enable_clock
 * @pre   \ref sl_si91x_gpio_driver_enable_pad_receiver()
 * @param[in]    gpio_num - GPIO number to be use
 ...
 * @pre   \ref sl_si91x_gpio_driver_enable_clock() \n
 * @pre   \ref sl_si91x_gpio_driver_enable_clock, for HP instance \n
 * @pre   \ref sl_si91x_gpio_driver_enable_pad_receiver(), for HP instance \n
 * @pre   \ref sl_si91x_gpio_driver_enable_ulp_pad_receiver(), for ULP instance \n
 *  Use corresponding pad receiver API for corresponding GPIO instance.
 * @pre   \ref sl_gpio_driver_set_pin_mode() \n
 * @pre   \ref sl_si91x_gpio_driver_set_pin_direction() \n
 * @pre   \ref sl_si91x_gpio_driver_configure_ulp_group_interrupt(), for HP instance \n
 * @pre   \ref sl_si91x_gpio_driver_configure_ulp_group_interrupt, for ULP instance \n
 ...
 * @pre   \ref sl_gpio_driver_set_pin_mode()
 * @pre   \ref sl_si91x_gpio_driver_set_pin_direction()
 * @pre   \ref sl_si91x_gpio_driver_configure_ulp_group_interrupt()
 * @param[in]    group_interrupt - Group interrupt number of type
 *                        \ref sl_si91x_group_interrupt_t
 * @return returns status 0 if successful,
 *               else error code.
 ...
 * @pre   \ref sl_si91x_gpio_driver_enable_clock() \n
 * @pre   \ref sl_si91x_gpio_driver_enable_ulp_pad_receiver() \n
 * @pre   \ref sl_gpio_driver_set_pin_mode() \n
 * @pre   \ref sl_si91x_gpio_driver_set_pin_direction() \n
 ...
 * @pre   \ref sl_si91x_gpio_driver_enable_clock() \n
 * @pre   \ref sl_si91x_gpio_driver_select_uulp_npss_receiver() \n
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_pin_mux() \n
 * @param[in]  pin  - is NPSS GPIO pin number (0...4)
 ...
 * @pre   \ref sl_si91x_gpio_driver_select_uulp_npss_receiver() \n
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_pin_mux() \n
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_direction() \n
 * @param[in]  pin - is NPSS GPIO pin number(0...4)
 ...
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_pin_mux() \n
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_direction() \n
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_pin_value() \n
 * @param[in]  pin  - is NPSS GPIO pin number (0...4)
 ...
 * @pre   \ref sl_si91x_gpio_driver_enable_clock() \n
 * @pre   \ref sl_si91x_gpio_set_uulp_pad_configuration() \n
 * @pre   \ref sl_si91x_gpio_driver_select_uulp_npss_receiver() \n
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_pin_mux() \n
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_direction() \n
 * @param[in]   npssgpio_interrupt - OR'ed values of the NPSS GPIO interrupts
 ...
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_pin_mux() \n
 * @pre   \ref sl_si91x_gpio_driver_set_uulp_npss_direction() \n
 * @pre   \ref sl_si91x_gpio_configure_uulp_interrupt() \n
 * @param[in]   npssgpio_interrupt - OR'ed values of the NPSS GPIO interrupts
 * @return returns status 0 if successful,
 *               else error code.
 *        \ref SL_STATUS_INVALID_PARAMETER (0x0021) - The parameter is invalid argument \n
 ...
 * @pre   \ref sl_gpio_driver_set_pin_mode() \n
 * @pre   \ref sl_si91x_gpio_driver_set_pin_direction() \n
 * @pre   \ref sl_si91x_gpio_configure_ulp_pin_interrupt() \n
