...
void sli_mvp_math_vector_add_i8(const int8_t *input_a, const int8_t *input_b, int8_t *output, size_t len)
{
  ...
  sli_mvp_prog_set_instr(&program,
                         SLI_MVP_INSTR(0),
                         SLI_MVP_OP(ADDC),
                         SLI_MVP_ALU_X(SLI_MVP_R1) | SLI_MVP_ALU_A(SLI_MVP_R2) | SLI_MVP_ALU_Z(SLI_MVP_R3),
...
//void sli_mvp_math_3_vector_add_i8(const int8_t *input_a, const int8_t *input_b,const int8_t *input_c,int8_t *intmd_buffer, int8_t *output, size_t len)
//{
//  static sli_mvp_program_t program;
//	static sli_mvp_program_t program_2;

//  // Configure 3 Arrays: Array0 = input_a Array1 = input_b Array2 = output
//  sli_mvp_prog_set_vector(&program, SLI_MVP_ARRAY(0), (void *)input_a, SLI_MVP_DATATYPE_INT8, len);
//  sli_mvp_prog_set_vector(&program, SLI_MVP_ARRAY(1), (void *)input_b, SLI_MVP_DATATYPE_INT8, len);
//  sli_mvp_prog_set_vector(&program, SLI_MVP_ARRAY(2), intmd_buffer, SLI_MVP_DATATYPE_INT8, len);
...
//  sli_mvp_execute(&program, false);
//
//
//	  // Configure 3 Arrays: Array0 = input_a Array1 = input_b Array2 = output
//  sli_mvp_prog_set_vector(&program_2, SLI_MVP_ARRAY(0), (void *)input_c, SLI_MVP_DATATYPE_INT8, len);
//  sli_mvp_prog_set_vector(&program_2, SLI_MVP_ARRAY(1), intmd_buffer, SLI_MVP_DATATYPE_INT8, len);
//  sli_mvp_prog_set_vector(&program_2, SLI_MVP_ARRAY(2), output, SLI_MVP_DATATYPE_INT8, len);
...
//  // R3 = ADDC(R1,_,R2)
//  // STORE(Array2, R3)
//  sli_mvp_prog_set_instr(&program_2,
//                         SLI_MVP_INSTR(0),
//                         SLI_MVP_OP(ADDC),
//                         SLI_MVP_ALU_X(SLI_MVP_R1) | SLI_MVP_ALU_A(SLI_MVP_R2) | SLI_MVP_ALU_Z(SLI_MVP_R3),
//                         SLI_MVP_LOAD(0, SLI_MVP_R1, SLI_MVP_ARRAY(0), SLI_MVP_INCRDIM_COL)
...
//  // Loop 0 is the outer loop, counting down columns
//  sli_mvp_prog_set_loop(&program_2,
//                        SLI_MVP_LOOP(0),
//                        len,              // iterate (once for each row)
//                        SLI_MVP_INSTR(0), // starts at Instruction 0
//                        SLI_MVP_INSTR(0), // ends at Instruction 0
//                        SLI_MVP_NONE);    // No increments with this loop
//
//	/*Wait till 1st program finishes*/
//	while(!dma_done)
//	;
//
//	/*execute next program*/
//	sli_mvp_execute(&program_2, true);
//}
...
void sli_mvp_math_clamp_i8(int8_t *data, size_t len, int8_t min, int8_t max)
{
  ...
  while (remaining >= threshold) {
    ...
    sli_mvp_prog_set_loop(&prog, SLI_MVP_LOOP(0), batch_size, SLI_MVP_INSTR(1), SLI_MVP_INSTR(2), SLI_MVP_NONE);
