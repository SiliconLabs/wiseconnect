...
#define SL_STATUS_BT_APPLICATION_ENCRYPTION_DECRYPTION_ERROR \
  ((sl_status_t)0x041E) ///< Encrypion/decryption operation failed.
...
#define SL_STATUS_BT_CTRL_ADVERTISING_TIMEOUT \
  ((sl_status_t)0x103C) ///< Ddvertising for a fixed duration completed or, for directed advertising, that advertising completed without a connection being created.
