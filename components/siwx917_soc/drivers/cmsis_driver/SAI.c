...
static I2S_DMA I2S0_UDMA_TX_CHNL = { { UDMA_MODE_BASIC,
                                       0,
...
static I2S_DMA I2S0_UDMA_RX_CHNL = { { UDMA_MODE_BASIC,
                                       0,
...
static I2S_DMA I2S1_UDMA_TX_CHNL = { { UDMA_MODE_BASIC,
                                       0,
...
static I2S_DMA I2S1_UDMA_RX_CHNL = { { UDMA_MODE_BASIC,
                                       0,
...
static int32_t I2S0_Initialize(ARM_SAI_SignalEvent_t cb_event)
{
  ...
  return ROMAPI_I2S_API
    ->I2S_Initialize(cb_event, &I2S0_Resources, &UDMA0_Resources, UDMA0_Table, &udmaHandle0, dma_rom_buff0);
#else
...
ARM_DRIVER_SAI Driver_SAI0 = { I2Sx_GetVersion,   I2S0_GetCapabilities, I2S0_Initialize,
                               I2S0_Uninitialize, I2S0_PowerControl,    I2S0_Send,
                               I2S0_Receive,      I2S0_GetTxCount,      I2S0_GetRxCount,
                               I2S0_Control,      I2S0_GetStatus };
#endif
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_I2S_API
    ->I2S_Initialize(cb_event, &I2S1_Resources, &UDMA1_Resources, UDMA1_Table, &udmaHandle1, dma_rom_buff1);
#else
...
ARM_DRIVER_SAI Driver_SAI1 = { I2Sx_GetVersion,   I2S1_GetCapabilities, I2S1_Initialize,
                               I2S1_Uninitialize, I2S1_PowerControl,    I2S1_Send,
                               I2S1_Receive,      I2S1_GetTxCount,      I2S1_GetRxCount,
                               I2S1_Control,      I2S1_GetStatus };
#endif
