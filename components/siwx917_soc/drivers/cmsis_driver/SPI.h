...
#if ((defined(RTE_Drivers_SSI_MASTER) || defined(RTE_Drivers_SSI_SLAVE) || defined(RTE_Drivers_SSI_ULP_MASTER)) \
     && (RTE_SSI_MASTER == 0) && (RTE_SSI_SLAVE == 0) && (RTE_SSI_ULP_MASTER == 0))
