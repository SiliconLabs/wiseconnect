...
// Driver Version
static const ARM_DRIVER_VERSION UsartDriverVersion = { ARM_USART_API_VERSION, ARM_USART_DRV_VERSION };
// USART AND UART1
#if (RTE_USART0)
...
static USART_PIN usart0_ir_tx = { RTE_USART0_IR_TX_PORT,
                                  RTE_USART0_IR_TX_PIN,
                                  RTE_USART0_IR_TX_MUX,
                                  RTE_USART0_IR_TX_PAD };
static USART_PIN usart0_ir_rx = { RTE_USART0_IR_RX_PORT,
                                  RTE_USART0_IR_RX_PIN,
                                  RTE_USART0_IR_RX_MUX,
                                  RTE_USART0_IR_RX_PAD };

#if (RTE_USART0_CHNL_UDMA_TX_EN == 1)
void USART0_UDMA_Tx_Event(uint32_t event, uint8_t dmaCh);
static USART_DMA USART0_UDMA_TX_CHNL = { { UDMA_MODE_BASIC,
                                           0,
...
static USART_DMA USART0_UDMA_RX_CHNL = { { UDMA_MODE_BASIC,
                                           0,
...
static USART_DMA UART1_UDMA_TX_CHNL = { { UDMA_MODE_BASIC,
                                          0,
...
static USART_DMA UART1_UDMA_RX_CHNL = { { UDMA_MODE_BASIC,
                                          0,
...
static USART_DMA ULPUART_UDMA_TX_CHNL = { { UDMA_MODE_BASIC,
                                            0,
...
static USART_DMA ULPUART_UDMA_RX_CHNL = { { UDMA_MODE_BASIC,
                                            0,
...
static int32_t ARM_USART0_Initialize(ARM_USART_SignalEvent_t cb_event)
{
  ...
  return ROMAPI_USART_API
    ->USART_Initialize(cb_event, &USART0_Resources, &UDMA0_Resources, UDMA0_Table, &udmaHandle0, dma_rom_buff0);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Send_Data(data, num, &USART0_Resources, &UDMA0_Resources, udma0_chnl_info, udmaHandle0);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Receive_Data(data, num, &USART0_Resources, &UDMA0_Resources, udma0_chnl_info, udmaHandle0);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Transfer(data_out, data_in, num, &USART0_Resources, &UDMA0_Resources, udma0_chnl_info, udmaHandle0);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Control(control, arg, usart0_get_clock, &USART0_Resources, &UDMA0_Resources, udmaHandle0);
#else
...
ARM_DRIVER_USART Driver_USART0 = { ARM_USARTx_GetVersion,      ARM_USART0_GetCapabilities, ARM_USART0_Initialize,
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Initialize(cb_event, &UART1_Resources, &UDMA0_Resources, UDMA0_Table, &udmaHandle0, dma_rom_buff0);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Receive_Data(data, num, &UART1_Resources, &UDMA0_Resources, udma0_chnl_info, udmaHandle0);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Transfer(data_out, data_in, num, &UART1_Resources, &UDMA0_Resources, udma0_chnl_info, udmaHandle0);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Control(control, arg, uart1_get_clock, &UART1_Resources, &UDMA0_Resources, udmaHandle0);
#else
...
#endif
// USART driver functions structure
ARM_DRIVER_USART Driver_UART1 = { ARM_USARTx_GetVersion,     ARM_UART1_GetCapabilities, ARM_UART1_Initialize,
                                  ARM_UART1_Uninitialize,    ARM_UART1_PowerControl,    ARM_UART1_Send,
                                  ARM_UART1_Receive,         ARM_UART1_Transfer,        ARM_UART1_GetTxCount,
                                  ARM_UART1_GetRxCount,      ARM_UART1_Control,         ARM_UART1_GetStatus,
                                  ARM_UART1_SetModemControl, ARM_UART1_GetModemStatus };
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Initialize(cb_event, &ULP_UART_Resources, &UDMA1_Resources, UDMA1_Table, &udmaHandle1, dma_rom_buff1);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Send_Data(data, num, &ULP_UART_Resources, &UDMA1_Resources, udma1_chnl_info, udmaHandle1);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Receive_Data(data, num, &ULP_UART_Resources, &UDMA1_Resources, udma1_chnl_info, udmaHandle1);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Transfer(data_out, data_in, num, &ULP_UART_Resources, &UDMA1_Resources, udma1_chnl_info, udmaHandle1);
#else
...
#if defined(A11_ROM) && defined(ROMDRIVER_PRESENT)
  return ROMAPI_USART_API
    ->USART_Control(control, arg, ulp_uart_get_clock, &ULP_UART_Resources, &UDMA1_Resources, udmaHandle1);
#else
...
#endif
// USART driver functions structure
ARM_DRIVER_USART Driver_ULP_UART = { ARM_USARTx_GetVersion,        ARM_ULP_UART_GetCapabilities,
                                     ARM_ULP_UART_Initialize,      ARM_ULP_UART_Uninitialize,
                                     ARM_ULP_UART_PowerControl,    ARM_ULP_UART_Send,
                                     ARM_ULP_UART_Receive,         ARM_ULP_UART_Transfer,
                                     ARM_ULP_UART_GetTxCount,      ARM_ULP_UART_GetRxCount,
                                     ARM_ULP_UART_Control,         ARM_ULP_UART_GetStatus,
                                     ARM_ULP_UART_SetModemControl, ARM_ULP_UART_GetModemStatus };
