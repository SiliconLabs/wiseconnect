...
#define ARM_NAND_DEVICE_READY_EVENT \
  (0x04) ///< Generate \ref ARM_NAND_EVENT_DEVICE_READY; arg: 0=disabled (default), 1=enabled
#define ARM_NAND_DRIVER_READY_EVENT \
  (0x05) ///< Generate \ref ARM_NAND_EVENT_DRIVER_READY; arg: 0=disabled (default), 1=enabled
...
#define ARM_NAND_BUS_SDR \
  (0x00UL                \
   << ARM_NAND_BUS_INTERFACE_Pos) ///< Data Interface:    SDR  (Single Data Rate) - Traditional interface (default)
...
#define ARM_NAND_BUS_DDR2_DO_WCYC_0 \
  (0x00UL << ARM_NAND_BUS_DDR2_DO_WCYC_Pos) ///< DDR2 Data Output Warm-up cycles: 0 (default)
...
#define ARM_NAND_BUS_DDR2_DI_WCYC_0 \
  (0x00UL << ARM_NAND_BUS_DDR2_DI_WCYC_Pos) ///< DDR2 Data Input Warm-up cycles: 0 (default)
...
typedef struct _ARM_NAND_ECC_INFO {
  ...
  uint32_t
    page_layout : 1; ///< Page layout: 0=|Data0|Spare0|...|DataN-1|SpareN-1|, 1=|Data0|...|DataN-1|Spare0|...|SpareN-1|
  uint32_t page_count : 3; ///< Number of virtual pages: N = 2 ^ page_count
  uint32_t
    page_size : 4; ///< Virtual Page size (Data+Spare): 0=512+16, 1=1k+32, 2=2k+64, 3=4k+128, 4=8k+256, 8=512+28, 9=1k+56, 10=2k+112, 11=4k+224, 12=8k+448
