...
// <o SL_ADC_CHANNEL_5_POS_INPUT_CHNL_SEL> POS Input Channel Selection <0-15>
// <i> Default: 0
#define SL_ADC_CHANNEL_5_POS_INPUT_CHNL_SEL 5

// <o SL_ADC_CHANNEL_5_NEG_INPUT_CHNL_SEL> NEG Input Channel Selection <0-8>
// <i> Default: 0
#define SL_ADC_CHANNEL_5_NEG_INPUT_CHNL_SEL 5
