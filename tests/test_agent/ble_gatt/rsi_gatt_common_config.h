...
#define RSI_BLE_MAIN_TASK_PRIORITY osPriorityNormal1
#define RSI_BLE_APP_TASK_PRIORITY  osPriorityNormal
#define SMP_ENABLE                 1

//! Application Task sizes
//TODO - review
#define RSI_BLE_APP_MAIN_TASK_SIZE (32 * 32)
#define RSI_BLE_APP_TASK_SIZE      (32 * 40)
