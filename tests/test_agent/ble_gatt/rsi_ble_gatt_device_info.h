...
typedef struct rsi_ble_conn_info_s {
  ...
  rsi_ble_event_remote_features_t remote_dev_feature; //! -- rsi_ble_simple_peripheral_on_remote_features_event_gatt()
  rsi_ble_event_adv_report_t rsi_app_adv_reports_to_app; //! -- rsi_ble_simple_central_on_adv_report_event_gatt()
  rsi_ble_event_conn_update_t conn_update_resp;          //! -- ble_on_conn_update_complete_event_gatt()
  rsi_ble_event_remote_conn_param_req_t
    rsi_app_remote_device_conn_params; //! -- rsi_ble_on_remote_conn_params_request_event_gatt()
  rsi_ble_event_conn_status_t
    conn_event_to_app; //! -- rsi_ble_on_connect_event_gatt()  rsi_ble_on_disconnect_event_gatt() rsi_ble_on_enhance_conn_status_event_gatt()
  rsi_ble_event_enhance_conn_status_t rsi_enhc_conn_status;
  uint8_t is_enhanced_conn;                  //! -- flag to indicate enhanced connection(1) or normal connection(0)
  rsi_ble_event_write_t app_ble_write_event; //! -- rsi_ble_on_gatt_write_event_gatt()
  ...
  rsi_ble_read_req_t app_ble_read_event;                      //! -- rsi_ble_on_read_req_event_gatt()
  rsi_ble_event_mtu_t app_ble_mtu_event;                      //! -- rsi_ble_on_mtu_event_gatt()
  rsi_ble_event_mtu_exchange_information_t mtu_exchange_info; //! --rsi_ble_on_mtu_exchange_info_t
  rsi_ble_event_disconnect_t rsi_ble_disconn_resp;            //! -- rsi_ble_on_disconnect_event_gatt()
  rsi_ble_event_profiles_list_t get_allprofiles;              //!	-- rsi_ble_profiles_list_event_gatt()
  rsi_ble_event_profile_by_uuid_t get_profile;                //!	-- rsi_ble_profile_event_gatt()
  rsi_ble_event_read_by_type1_t get_char_services;            //! -- rsi_ble_char_services_event_gatt()
