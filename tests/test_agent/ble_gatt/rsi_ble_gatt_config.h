...
#define CONNECT_OPTION          CONN_BY_ADDR //CONN_BY_NAME
...
//! configure below macro to perform data transfer
#define DATA_TRANSFER_S1 0
//!configure below macros to select type of data transfer
//! set below macro to receive 'gatt notifications' from remote device
#define RX_NOTIFICATIONS_FROM_S1 0
//! set below macro to receive 'gatt indications' from remote device
...
#define DLE_BUFFER_COUNT_S1     1  //TODO : changed from 2 to 1
...
#define RSI_BLE_CLIENT_WRITE_SERVICE_UUID_M1 0x180F //! Battery Service
#define RSI_BLE_CLIENT_WRITE_CHAR_UUID_M1    0x2A19 //! Battery Characteritic

#define RSI_BLE_CLIENT_WRITE_NO_RESP_SERVICE_UUID_M1 0x180F //! Battery Service
#define RSI_BLE_CLIENT_WRITE_NO_RESP_CHAR_UUID_M1    0x2A19 //! Battery Characteritic

#define RSI_BLE_CLIENT_INIDCATIONS_SERVICE_UUID_M1 0x180F //! Battery Service
#define RSI_BLE_CLIENT_INIDCATIONS_CHAR_UUID_M1    0x2A19 //! Battery Characteritic

#define RSI_BLE_CLIENT_NOTIFICATIONS_SERVICE_UUID_M1 0x180F //! Battery Service
#define RSI_BLE_CLIENT_NOTIFICATIONS_CHAR_UUID_M1    0x2A19 //! Battery Characteritic
...
typedef struct rsi_ble_conn_config_s {
  uint8_t conn_id;
  uint8_t smp_enable;
  uint8_t add_to_acceptlist;
  uint8_t profile_discovery;
  uint8_t data_transfer;
  //	uint8_t bidir_datatransfer;
  uint8_t rx_notifications;
  //    uint8_t rx_write;
  //    uint8_t rx_write_no_response;
  uint8_t rx_indications;
  uint8_t tx_notifications;
  uint8_t tx_write;
  uint8_t tx_write_no_response;
  uint8_t tx_indications;
