...
typedef enum {
  ...
  CONSOLE_TYPE(sl_wifi_timeout_type_t),
...
extern const char *cert_type_type[];
extern const char *continuous_flag_type[];
extern const char *credential_id_type[];
...
extern const char *sl_wifi_timeout_type_t_type[];
